...
local v79 = game:GetService("ReplicatedStorage")
game:GetService("VirtualUser")
game:GetService("RunService")
game:GetService("HttpService")
local v80 = v78.LocalPlayer
v79:WaitForChild("Remotes", 5):WaitForChild("CommF_", 5)
v80:WaitForChild("PlayerGui", 5):WaitForChild("Main", 5)
local _ = 10 > tick() - 0
local v81 = game:GetService("ReplicatedStorage")
local v82 = v81:FindFirstChild("Effect")
if v82 then
    v82 = v81.Effect:FindFirstChild("Container")
end
if v82 then
    local v83 = v82:FindFirstChild("Death")
    if v83 then
        local v84, v85 = pcall(require, v83)
        if v84 and type(v85) == "function" then
            hookfunction(v85, function()
            end)
        end
    end
    local v86 = v82:FindFirstChild("Respawn")
    if v86 then
        local v87, v88 = pcall(require, v86)
        if v87 and type(v88) == "function" then
            hookfunction(v88, function()
            end)
        end
    end
end
local v89 = v81:FindFirstChild("GuideModule")
if v89 then
    local v90, v91 = pcall(require, v89)
    if v90 and (v91 and type(v91.ChangeDisplayedNPC) == "function") then
        hookfunction(v91.ChangeDisplayedNPC, function()
        end)
    end
end
local v92 = game:GetService("ReplicatedStorage"):WaitForChild("Util", 5)
local v93 = v92 and v92:FindFirstChild("CameraShaker")
if v93 then
    require(v93):Stop()
end
...
function MaterialMon()
    local v95 = game.Players.LocalPlayer
    local vu96 = v95.Character
    if vu96 then
        vu96 = v95.Character:FindFirstChild("HumanoidRootPart")
    end
    if vu96 then
        local function v99(p97, p98)
			-- upvalues: (ref) vu96
            if p98 <= (vu96.Position - p97).Magnitude then
...
local vu101 = 1
function AutoHaki()
	-- upvalues: (ref) vu100, (ref) vu101
    if not game:GetService("Players").LocalPlayer.Character:FindFirstChild("HasBuso") then
        local v102 = tick()
        if vu101 <= v102 - vu100 then
...
function UnEquipWeapon(p105)
	-- upvalues: (ref) vu103, (ref) vu104
    local v106 = tick()
    if vu104 <= v106 - vu103 then
...
function BTP(p112)
    ...
    local v115 = v113.Character.Humanoid
    local v116 = v113.PlayerGui.Main
    local _ = p112.Position
    local v117 = v114.Position
    while true do
        v115.Health = 0
        v114.CFrame = p112
        v116.Quest.Visible = false
        if (v114.Position - v117).Magnitude > 1 then
            v117 = v114.Position
            v114.CFrame = p112
        end
        task.wait(0.5)
        if (p112.Position - v114.Position).Magnitude <= 2000 then
            return
        end
    end
end
function BTPZ(p118)
    ...
    if v119.Character and v119.Character:FindFirstChild("HumanoidRootPart") then
        v119.Character.HumanoidRootPart.CFrame = p118
    end
end
local vu120 = 0
local vu121 = 0.5
function fastpos(p122)
	-- upvalues: (ref) vu120, (ref) vu121
    local v123 = tick()
    if vu121 <= v123 - vu120 then
        local v124 = (p122.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude
        game:GetService("TweenService"):Create(game:GetService("Players").LocalPlayer.Character.HumanoidRootPart, TweenInfo.new(v124 / 1000, Enum.EasingStyle.Linear), {
            ["CFrame"] = p122
        }):Play()
        vu120 = v123
    end
...
function TPB(p127, p128)
	-- upvalues: (ref) vu125, (ref) vu126
    local v129 = tick()
    if vu126 <= v129 - vu125 then
        local v130 = game:GetService("TweenService")
        local v131 = (p128.CFrame.Position - p127.Position).Magnitude
        local v132 = getgenv().SpeedBoat
        local v133 = TweenInfo.new(v131 / v132, Enum.EasingStyle.Linear)
        if v131 <= 25 then
            return {
                ["Stop"] = function()
                end
        ...
        local vu134 = v130:Create(p128, v133, {
            ["CFrame"] = p127
        })
        local v135 = vu134
        vu134.Play(v135)
...
function EquipAllWeapon()
	-- upvalues: (ref) vu136, (ref) vu137
    pcall(function()
		-- upvalues: (ref) vu136, (ref) vu137
        local v138 = tick()
        if vu137 <= v138 - vu136 then
...
function CheckNearestTeleporter(p144)
    ...
    local v145 = p144.Position
    local v146 = math.huge
    local v147 = math.huge
    local v148 = game.PlaceId
    local v149 = nil
    local v150 = nil
    local v151 = nil
    if v148 == 2753915549 then
        v149 = true
    elseif v148 == 4442272183 then
        v150 = true
    elseif v148 == 7449423635 then
        v151 = true
    end
    local v152 = {}
    local v153
    ...
    if v147 <= (v145 - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude then
        return v167
    end
end
function requestEntrance(p169)
    ...
    local v170 = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(v170.X, v170.Y + 50, v170.Z)
    task.wait(0.5)
end
function topos(pu171)
    pcall(function()
		-- upvalues: (ref) pu171
        if game:GetService("Players").LocalPlayer and (game:GetService("Players").LocalPlayer.Character and (game:GetService("Players").LocalPlayer.Character:FindFirstChild("Humanoid") and (game:GetService("Players").LocalPlayer.Character:FindFirstChild("HumanoidRootPart") and (game:GetService("Players").LocalPlayer.Character.Humanoid.Health > 0 and game:GetService("Players").LocalPlayer.Character.HumanoidRootPart)))) then
            ...
            DefualtY = pu171.Y
            TargetY = pu171.Y
            targetCFrameWithDefualtY = CFrame.new(pu171.X, DefualtY, pu171.Z)
            targetPos = pu171.Position
            oldcframe = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame
            Distance = (targetPos - game:GetService("Players").LocalPlayer.Character:WaitForChild("HumanoidRootPart").Position).Magnitude
            if Distance <= 300 then
                game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = pu171
            end
            local v172 = CheckNearestTeleporter(pu171)
            if v172 then
                pcall(function()
                    tween:Cancel()
                end)
            ...
            if IngoreY and (b1.Position - targetCFrameWithDefualtY.Position).Magnitude > 5 then
                ...
                local v173 = game:GetService("TweenService")
                ...
                tween = v173:Create(game:GetService("Players").LocalPlayer.Character.HumanoidRootPart, v174, {
                ...
                local v175 = game:GetService("TweenService")
                ...
                tween = v175:Create(game:GetService("Players").LocalPlayer.Character.HumanoidRootPart, v176, v177)
                tween:Play();
                ({}).Stop = function(_)
                    tween:Cancel()
                end
...
function StopTween(pu178)
    pcall(function()
        ...
        if not pu178 then
            ...
            if v179 then
                v179 = v179:FindFirstChild("HumanoidRootPart")
            end
            if v179 then
                v179.Anchored = true
                task.wait(0.1)
                v179.CFrame = v179.CFrame
                v179.Anchored = false
            end
            if v179 then
                v179 = v179:FindFirstChild("BodyClip")
            end
            if v179 then
                v179:Destroy()
            end
        ...
        pcall(function()
            if getgenv().TeleportIsland or (getgenv().AutoFarm or (getgenv().AutoMaterial or (getgenv().MasteryFarm or (getgenv().AutoGetMelee or (getgenv().TeleportToFruit or (getgenv().AutoNewWorld or (getgenv().AutoThirdSea or (getgenv().AutoFactory or (getgenv().AutoPirateRaid or (getgenv().AutoEliteHunter or (getgenv().AutoTouchPadHaki or (getgenv().AutoRipIndra or (getgenv().AutoSoulReaper or (getgenv().AutoDoughKing or (getgenv().AutoDarkbeard or (getgenv().DojoClaimQuest or (getgenv().DragonTalonUpgrade or (getgenv().BlazeEmberFarm or (getgenv().AutoObservationHakiV2 or (getgenv().AutoObservation or (getgenv().AutoFarmBoss or (getgenv().AutoFarmAllBoss or (getgenv().Auto_Dungeon or (getgenv().SailBoat or (getgenv().RelzFishBoat or (getgenv().RelzPirateBrigade or (getgenv().RelzPirateGrandBrigade or (getgenv().AutoTerrorshark or (getgenv().AutoSeaBest or (getgenv().AutoFrozenDimension or (getgenv().KillLevi or (getgenv().UpgradeRaceV2 or (getgenv().AutoCyborg or (getgenv().AutoGhoul or (getgenv().QuestTrain_2 or (getgenv().TeleportMigare or (getgenv().Tweentohighestpoint or (getgenv().TeleportToGear or (getgenv().AutoTrialRace or (getgenv().AutoKillPlayerAfterTrial or (getgenv().AutoRainbowHaki or (getgenv().AutoSkullGuitar or (getgenv().AutoGetCDK or (getgenv().AutoTushita or (getgenv().AutoSaber or getgenv().TeleportPlayer))))))))))))))))))))))))))))))))))))))))))))) then
                if not game:GetService("Players").LocalPlayer.Character.HumanoidRootPart:FindFirstChild("BodyClip") then
                    local v180 = Instance.new("BodyVelocity")
                    v180.Name = "BodyClip"
                    v180.Parent = game:GetService("Players").LocalPlayer.Character.HumanoidRootPart
                    v180.MaxForce = Vector3.new(100000, 100000, 100000)
                    v180.Velocity = Vector3.new(0, 0, 0)
                end
            else
                local v181 = game:GetService("Players").LocalPlayer.Character.HumanoidRootPart:FindFirstChild("BodyClip")
                if v181 then
                    v181:Destroy()
                end
            end
...
local vu190 = game.Players.LocalPlayer
local function vu193(p191)
    if not p191 then
        return false
    end
    local v192 = p191:FindFirstChild("Humanoid")
    if v192 then
        v192 = v192.Health > 0
    end
    return v192
end
local function vu210(p194, p195)
	-- upvalues: (ref) vu193, (ref) vu190
    local v196 = game:GetService("Workspace").Enemies:GetChildren()
    local v197 = game:GetService("Players"):GetPlayers()
    local v198 = p194:GetPivot().Position
    ...
    while true do
        ...
        local v204 = v203:FindFirstChild("HumanoidRootPart")
        if v204 and (vu193(v203) and (v204.Position - v198).Magnitude <= p195) then
    ...
    while true do
        ...
        if v208 ~= vu190 and v208.Character then
            local v209 = v208.Character:FindFirstChild("HumanoidRootPart")
            if v209 and (vu193(v208.Character) and (v209.Position - v198).Magnitude <= p195) then
...
function AttackNoCoolDown()
	-- upvalues: (ref) vu190, (ref) vu210
    local v211 = vu190.Character
    if not v211 then
        return
    end
    local v212, v213, v214 = ipairs(v211:GetChildren())
    local v215 = nil
    while true do
        local v216
    ...
    if v216 then
        ...
        if v216:FindFirstChild("LeftClickRemote") then
            ...
            while true do
                ...
                v220 = v222
                local v224 = v223:FindFirstChild("HumanoidRootPart")
                if v224 then
                    local v225 = (v224.Position - v211:GetPivot().Position).Unit
                    v216.LeftClickRemote:FireServer(v225, v221)
                    v221 = v221 + 1
                end
            end
        else
            ...
            while true do
                ...
                if not v232:GetAttribute("IsBoat") then
                    local v233 = v232:FindFirstChild("Head")
                    if v233 then
                        table.insert(vu229, {
                            v232,
                            v233
            ...
            if vu230 then
                local v234 = game:GetService("ReplicatedStorage")
                local vu235 = v234:WaitForChild("Modules"):WaitForChild("Net"):WaitForChild("RE/RegisterAttack")
                local vu236 = v234:WaitForChild("Modules"):WaitForChild("Net"):WaitForChild("RE/RegisterHit")
                pcall(function()
					-- upvalues: (ref) vu235, (ref) vu236, (ref) vu230, (ref) vu229
                    vu235:FireServer(0.1)
                    vu236:FireServer(vu230, vu229)
                end)
            end
        end
    end
...
Shop:AddButton({
    ...
    ["Callback"] = function()
        ...
        while true do
            local vu242
            v240, vu242 = v238(v239, v240)
            if v240 == nil then
                break
            end
            spawn(function()
				-- upvalues: (ref) vu242, (ref) vu241
                RedeemCode(vu242)
                wait(vu241)
            end)
        end
...
local vu243 = game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("CommF_")
Shop:AddButton({
    ...
    ["Callback"] = function()
        ...
        local _, _ = pcall(function()
			-- upvalues: (ref) vu243
            return vu243:InvokeServer("TravelMain")
        end)
    end
})
local vu244 = game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("CommF_")
Shop:AddButton({
    ...
    ["Callback"] = function()
        ...
        local _, _ = pcall(function()
			-- upvalues: (ref) vu244
            return vu244:InvokeServer("TravelDressrosa")
        end)
    end
})
local vu245 = game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("CommF_")
Shop:AddButton({
    ...
    ["Callback"] = function()
        ...
        local _, _ = pcall(function()
			-- upvalues: (ref) vu245
            return vu245:InvokeServer("TravelZou")
        end)
    end
})
Shop:AddParagraph({
...
local vu246 = game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("CommF_")
Shop:AddButton({
    ["Title"] = "Black Leg",
    ["Callback"] = function()
		-- upvalues: (ref) vu246
        local _, _ = pcall(function()
			-- upvalues: (ref) vu246
            return vu246:InvokeServer("BuyBlackLeg")
        end)
    end
})
local vu247 = game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("CommF_")
Shop:AddButton({
    ...
    ["Callback"] = function()
        ...
        local _, _ = pcall(function()
			-- upvalues: (ref) vu247
            return vu247:InvokeServer("BuyFishmanKarate")
        end)
    end
})
local vu248 = game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("CommF_")
Shop:AddButton({
    ["Title"] = "Electro",
    ["Callback"] = function()
		-- upvalues: (ref) vu248
        local _, _ = pcall(function()
			-- upvalues: (ref) vu248
            return vu248:InvokeServer("BuyElectro")
        end)
    end
})
local vu249 = game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("CommF_")
Shop:AddButton({
    ["Title"] = "Dragon Breath",
    ["Callback"] = function()
		-- upvalues: (ref) vu249
        local v250, _ = pcall(function()
			-- upvalues: (ref) vu249
            return vu249:InvokeServer("BlackbeardReward", "DragonClaw", "1")
        end)
        if v250 then
            local v251, _ = pcall(function()
				-- upvalues: (ref) vu249
                return vu249:InvokeServer("BlackbeardReward", "DragonClaw", "2")
            end)
            if not v251 then
            end
        else
...
Shop:AddButton({
    ...
    ["Callback"] = function()
        local v252 = game:GetService("ReplicatedStorage").Remotes.CommF_
        v252:InvokeServer("BuySharkmanKarate", true)
        wait(0.2)
        v252:InvokeServer("BuySharkmanKarate")
    end
})
Shop:AddButton({
    ["Title"] = "Electric Claw",
...
Shop:AddButton({
    ["Title"] = "Sanguine Art",
    ["Callback"] = function()
        local v253 = game:GetService("ReplicatedStorage").Remotes.CommF_
        v253:InvokeServer("BuySanguineArt", true)
        wait(0.2)
        v253:InvokeServer("BuySanguineArt")
    end
})
Shop:AddParagraph({
...
function UpdateOS()
    local v254 = os.date("*t")
    local v255 = v254.hour % 24
    local v256 = v255 < 12 and "AM" or "PM"
    local v257 = string.format("%02i:%02i:%02i %s", (v255 - 1) % 12 + 1, v254.min, v254.sec, v256)
    local v258 = string.format("%02d/%02d/%04d", v254.day, v254.month, v254.year)
    local vu259 = game:GetService("LocalizationService")
    local vu260 = game:GetService("Players").LocalPlayer
    local _ = vu260.Name
    local v261
    if getgenv().countryRegionCode then
        ...
        v262, v261 = pcall(function()
			-- upvalues: (ref) vu259, (ref) vu260
            return vu259:GetCountryRegionForPlayerAsync(vu260)
        end)
        if v262 then
...
spawn(function()
    ...
    pcall(function()
        ...
        while true do
            repeat
                wait(1)
                local v268 = game.Workspace._WorldOrigin.Locations:FindFirstChild("Mirage Island") ~= nil and "\226\156\133\239\184\143" or "\226\157\140\239\184\143"
            until v268 ~= vu267
...
spawn(function()
    ...
    while task.wait(1) do
        local v270 = game:GetService("Workspace").Map:FindFirstChild("KitsuneIsland") and "\226\156\133\239\184\143" or "\226\157\140\239\184\143"
        if v270 ~= v269 then
...
task.spawn(function()
    local v271 = ""
    while task.wait(1) do
        local v272 = game.Workspace._WorldOrigin.Locations:FindFirstChild("Prehistoric Island") and "\226\156\133\239\184\143" or "\226\157\140\239\184\143"
        if v272 ~= v271 then
...
spawn(function()
    local v273 = ""
    while wait(1) do
        local v274 = game.Workspace._WorldOrigin.Locations:FindFirstChild("Frozen Dimension") and "\226\156\133\239\184\143" or "\226\157\140\239\184\143"
        if v274 ~= v273 then
...
spawn(function()
    while wait(1) do
        local v275 = game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")
        local v276 = string.len(v275) < 86 and "Cake Prince: \226\156\133\239\184\143" or "Kill: " .. string.sub(v275, 39, 41)
...
spawn(function()
    local v277 = ""
    while wait(1) do
        local v278 = game:GetService("ReplicatedStorage"):FindFirstChild("rip_indra True Form") or (game:GetService("Workspace").Enemies:FindFirstChild("rip_indra") and "\226\156\133\239\184\143" or "\226\157\140\239\184\143")
        if v278 ~= v277 then
...
spawn(function()
    local v279 = ""
    while wait(1) do
        local v280 = game:GetService("ReplicatedStorage"):FindFirstChild("Dough King") or (game:GetService("Workspace").Enemies:FindFirstChild("Dough King") and "\226\156\133\239\184\143" or "\226\157\140\239\184\143")
        if v280 ~= v279 then
...
spawn(function()
    local v281 = ""
    while wait(1) do
        local v282 = (game:GetService("ReplicatedStorage"):FindFirstChild("Diablo") or (game:GetService("ReplicatedStorage"):FindFirstChild("Deandre") or (game:GetService("ReplicatedStorage"):FindFirstChild("Urban") or (game:GetService("Workspace").Enemies:FindFirstChild("Diablo") or (game:GetService("Workspace").Enemies:FindFirstChild("Deandre") or game:GetService("Workspace").Enemies:FindFirstChild("Urban")))))) and ("\226\156\133\239\184\143" or "\226\157\140\239\184\143") or "\226\157\140\239\184\143"
        local v283 = game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("EliteHunter", "Progress")
        if v282 ~= v281 then
            EliteHunter:SetDesc("Status: " .. v282 .. " | Killed: " .. v283)
            v281 = v282
        end
    end
end)
...
task.spawn(function()
    while task.wait(1) do
        local v284 = game:GetService("Lighting").Sky.MoonTextureId
        local v285 = v284 == "http://www.roblox.com/asset/?id=9709149431" and "Moon: 5/5" or (v284 == "http://www.roblox.com/asset/?id=9709149052" and "Moon: 4/5" or (v284 == "http://www.roblox.com/asset/?id=9709143733" and "Moon: 3/5" or (v284 == "http://www.roblox.com/asset/?id=9709150401" and "Moon: 2/5" or (v284 == "http://www.roblox.com/asset/?id=9709149680" and "Moon: 1/5" or "Moon: 0/5"))))
        FM:SetDesc(v285)
    end
end)
...
Server:AddButton({
    ["Title"] = "Join Server",
    ["Callback"] = function()
		-- upvalues: (ref) vu291, (ref) vu292
        if vu292 <= tick() - vu291 then
            vu291 = tick()
            game:GetService("TeleportService"):TeleportToPlaceInstance(game.placeId, getgenv().Job, game.Players.LocalPlayer)
        end
    end
...
Server:AddButton({
    ["Title"] = "Copy JobId",
    ["Callback"] = function()
		-- upvalues: (ref) vu293, (ref) vu294
        if vu294 > tick() - vu293 then
...
Server:AddButton({
    ["Title"] = "Rejoin Server",
    ["Callback"] = function()
		-- upvalues: (ref) vu295, (ref) vu296
        if vu296 <= tick() - vu295 then
            vu295 = tick()
...
function Hop()
    local vu297 = game.PlaceId
    local vu298 = {}
    local vu299 = ""
    local vu300 = os.date("!*t").hour
    function TPReturner()
		-- upvalues: (ref) vu299, (ref) vu297, (ref) vu298, (ref) vu300
        local v301
        if vu299 ~= "" then
            v301 = game.HttpService:JSONDecode(game:HttpGet("https://games.roblox.com/v1/games/" .. vu297 .. "/servers/Public?sortOrder=Asc&limit=100&cursor=" .. vu299))
        else
            v301 = game.HttpService:JSONDecode(game:HttpGet("https://games.roblox.com/v1/games/" .. vu297 .. "/servers/Public?sortOrder=Asc&limit=100"))
        end
        if v301.nextPageCursor and (v301.nextPageCursor ~= "null" and v301.nextPageCursor ~= nil) then
            vu299 = v301.nextPageCursor
        end
        ...
        while true do
            ...
            local v307 = true
            local vu308 = tostring(v306.id)
            if tonumber(v306.maxPlayers) > tonumber(v306.playing) then
                local v309, v310, v311 = pairs(vu298)
                while true do
                    local v312
                    ...
                    if v305 == 0 then
                        if tonumber(vu300) ~= tonumber(v312) then
                            pcall(function()
								-- upvalues: (ref) vu298, (ref) vu300
                                vu298 = {}
                                table.insert(vu298, vu300)
                            end)
                        end
                    elseif vu308 == tostring(v312) then
                        v307 = false
                    end
                    v305 = v305 + 1
                end
                if v307 == true then
                    table.insert(vu298, vu308)
                    wait(0.1)
                    pcall(function()
						-- upvalues: (ref) vu297, (ref) vu308
                        game:GetService("TeleportService"):TeleportToPlaceInstance(vu297, vu308, game.Players.LocalPlayer)
                    end)
                    wait(1)
                    break
                end
...
LGa:AddButton({
    ...
    ["Callback"] = function()
        ...
        local v314, _ = pcall(function()
			-- upvalues: (ref) vu313
            return game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(vu313))
        end)
        if v314 then
...
LGa:AddButton({
    ["Title"] = "Open Color",
    ["Callback"] = function()
		-- upvalues: (ref) vu315, (ref) vu316
        if vu316 <= tick() - vu315 then
            vu315 = tick()
            local v317 = game.Players.LocalPlayer.PlayerGui.Main:FindFirstChild("Colors")
            if v317 then
                v317.Visible = true
            end
        end
...
function FPSBooster()
    local vu318 = true
    local v319 = game
    local v320 = v319.Workspace
    local v321 = v319.Lighting
    local v322 = v320.Terrain
    sethiddenproperty(v321, "Technology", 2)
    sethiddenproperty(v322, "Decoration", false)
    v322.WaterWaveSize = 0
    v322.WaterWaveSpeed = 0
    v322.WaterReflectance = 0
    v322.WaterTransparency = 0
    v321.GlobalShadows = false
    v321.FogEnd = 9000000000
    v321.Brightness = 0
    ...
    local function v324(p323)
        ...
        if p323:IsA("Part") or (p323:IsA("Union") or (p323:IsA("CornerWedgePart") or p323:IsA("TrussPart"))) then
            ...
            p323.Reflectance = 0
        elseif p323:IsA("Decal") or p323:IsA("Texture") and vu318 then
            p323.Transparency = 1
        ...
        elseif p323:IsA("MeshPart") then
            p323.Material = "Plastic"
            p323.Reflectance = 0
            p323.TextureID = 1.0385902758728956e16
        end
    end
    local v325, v326, v327 = pairs(v320:GetDescendants())
    while true do
        local v328
    ...
    local v329, v330, v331 = pairs(v321:GetChildren())
    while true do
        local v332
...
spawn(function()
    while true do
        repeat
            ...
            local v335 = v334 and v334:FindFirstChild("Data") and (v334.Data:FindFirstChild("Points") and (v334.Data.Points.Value >= PointStats and getgenv().AutoStats) and ({
                ["Melee"] = "Melee",
                ["Defense"] = "Defense",
                ["Sword"] = "Sword",
                ["Gun"] = "Gun",
...
local vu344 = 1
spawn(function()
	-- upvalues: (ref) vu343, (ref) vu344
    while task.wait() do
        if getgenv().AutoSpawnCP and vu344 <= tick() - vu343 then
            vu343 = tick()
...
local vu347 = 0.5
spawn(function()
	-- upvalues: (ref) vu346, (ref) vu347
    while task.wait() do
        if vu347 <= tick() - vu346 then
            vu346 = tick()
...
LGa:AddButton({
    ...
    ["Callback"] = function()
        ...
        while true do
            local vu376
            v373, vu376 = v371(v372, v373)
            if v373 == nil or v374 <= v375 then
                break
            end
            v375 = v375 + 1
            vu376.Parent = game.Workspace.Map
            vu376:MoveTo(game.Players.LocalPlayer.Character.PrimaryPart.Position + Vector3.new(math.random(- 50, 50), 100, math.random(- 50, 50)))
            local v377 = vu376.Fruit:FindFirstChild("AnimationController")
            local v378 = v377 and v377:FindFirstChild("Idle")
            if v378 then
                v378:Play()
            end
            vu376.Handle.Touched:Connect(function(p379)
				-- upvalues: (ref) vu376
                if p379.Parent == game.Players.LocalPlayer.Character then
                    vu376.Parent = game.Players.LocalPlayer.Backpack
                    game.Players.LocalPlayer.Character.Humanoid:EquipTool(vu376)
                end
            end)
        end
    end
...
task.spawn(function()
    ...
    while task.wait(0.5) do
        pcall(function()
			-- upvalues: (ref) vu385
            if getgenv().SelectWeapon == vu385 then
                return
            end
            vu385 = getgenv().SelectWeapon
...
spawn(function()
    ...
    while task.wait(0.1) do
        if getgenv().AUTOHAKI and (not game.Players.LocalPlayer.Character:FindFirstChild("HasBuso") and v392) then
            ...
            pcall(function()
				-- upvalues: (ref) vu394
                game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(vu394))
            end)
            wait(v393)
            v392 = true
        end
...
task.spawn(function()
    ...
    while true do
        ...
        if v397 - v396 >= 0.5 then
            local v398 = game.Players.LocalPlayer.Character
            if v398 and (v398:FindFirstChild("RaceEnergy") and (v398.RaceEnergy.Value >= 1 and not v398.RaceTransformed.Value)) then
                local v399 = game:GetService("VirtualInputManager")
                v399:SendKeyEvent(true, "Y", false, game)
                task.wait(0.1)
                v399:SendKeyEvent(false, "Y", false, game)
                v396 = v397
            else
                v396 = v397
            end
...
task.spawn(function()
    ...
    while true do
        ...
        pcall(function()
			-- upvalues: (ref) vu401
            if getgenv().AutoTurnOnV3 ~= vu401 then
                if getgenv().AutoTurnOnV3 then
                    game:GetService("ReplicatedStorage").Remotes.CommE:FireServer("ActivateAbility")
                end
                vu401 = getgenv().AutoTurnOnV3
            end
        end)
    end
end)
local v402 = Settings:AddToggle("Toggle", {
    ["Title"] = "Auto Set Spawn Point",
    ["Default"] = false
})
local vu403 = false
v402:OnChanged(function(p404)
	-- upvalues: (ref) vu403
    getgenv().Set = p404
    if p404 ~= vu403 then
        vu403 = p404
...
task.spawn(function()
    while true do
        if getgenv().AntiAFK then
            local vu406 = game:GetService("VirtualUser")
            game:GetService("Players").LocalPlayer.Idled:Connect(function()
				-- upvalues: (ref) vu406
                vu406:Button2Down(Vector2.new(0, 0), workspace.CurrentCamera.CFrame)
                wait(1)
                vu406:Button2Up(Vector2.new(0, 0), workspace.CurrentCamera.CFrame)
            end)
        end
...
local v409 = Settings:AddToggle("Toggle", {
    ["Title"] = "Fast Attack",
    ["Default"] = true
})
local vu410 = nil
local function vu411()
...
v409:OnChanged(function(p412)
	-- upvalues: (ref) vu410, (ref) vu411
    getgenv().FastAttack = p412
    if p412 and not vu410 then
        vu410 = task.spawn(vu411)
    end
    if not p412 and vu410 then
        vu410 = nil
    end
end)
Settings:AddToggle("Toggle", {
...
local vu415 = game:GetService("Workspace")
local vu416 = v414.LocalPlayer
spawn(function()
	-- upvalues: (ref) vu415, (ref) vu416
    while task.wait(0.1) do
        pcall(function()
			-- upvalues: (ref) vu415, (ref) vu416
            CheckQuest()
            local v417 = vu415.Enemies:GetChildren()
            ...
            while true do
                ...
                if getgenv().BringMonster and (v422:FindFirstChild("Humanoid") and v422:FindFirstChild("HumanoidRootPart")) then
                    local v423 = v422:FindFirstChild("Humanoid")
                    local v424 = v422:FindFirstChild("HumanoidRootPart")
                    if v423 and (v424 and vu416.Character) and vu416.Character:FindFirstChild("HumanoidRootPart") then
                        local v425 = (v424.Position - vu416.Character.HumanoidRootPart.Position).Magnitude
                        if getgenv().StartMagnet and (v422.Name == MonFarm or v422.Name == Mon) and (v423.Health > 0 and v425 <= 350) then
                            if v422.Name ~= "Factory Staff" or (not PosMon or (v424.Position - PosMon.Position).Magnitude > 5000) then
                                if (v422.Name == MonFarm or v422.Name == Mon) and (PosMon and ((v424.Position - PosMon.Position).Magnitude <= 4500 and v424.Parent)) then
                                    v424.CanCollide = false
                                    v424.Size = Vector3.new(60, 60, 60)
                                    v424.CFrame = PosMon
                                    v422.Head.CanCollide = false
                                    local vu426 = v423:FindFirstChild("Animator")
                                    if vu426 then
                                        pcall(function()
											-- upvalues: (ref) vu426
                                            vu426:Destroy()
                                    ...
                                    sethiddenproperty(vu416, "SimulationRadius", math.huge)
                                    v421 = v421 + 1
                                end
                            elseif v424.Parent then
                                v424.CanCollide = false
                                v424.Size = Vector3.new(60, 60, 60)
                                v424.CFrame = PosMon
                                v422.Head.CanCollide = false
                                local vu427 = v423:FindFirstChild("Animator")
                                if vu427 then
                                    pcall(function()
										-- upvalues: (ref) vu427
                                        vu427:Destroy()
...
spawn(function()
    while wait(0.1) do
        if getgenv().ReduceLag then
            ...
            while true do
                local vu434
                v433, vu434 = v431(v432, v433)
                if v433 == nil then
                    break
                end
                if vu434 and (vu434.Name == "CurvedRing" or (vu434.Name == "SlashHit" or (vu434.Name == "SwordSlash" or (vu434.Name == "SlashTail" or vu434.Name == "Sounds")))) then
                    pcall(function()
						-- upvalues: (ref) vu434
                        vu434:Destroy()
                    end)
    ...
    while task.wait(5) do
        pcall(function()
            if getgenv().ResetFlags then
                ...
                local v437, v438, v439 = pairs(v436.Character:GetDescendants())
                while true do
                    local v440
                ...
                local v441, v442, v443 = pairs(v436.PlayerScripts:GetDescendants())
                while true do
                    local v444
...
spawn(function()
    ...
    while wait(v446) do
        if getgenv().AutoFarm and (FarmMode == "Farm Level" and v447) then
            spawn(function()
                local v448 = game:GetService("Players").LocalPlayer
                local v449 = v448.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text
                local v450 = v448.PlayerGui.Main.Quest.Visible
                local v451 = v448.Character
                if v451 then
                    v451 = v448.Character:FindFirstChild("HumanoidRootPart")
                end
                if not string.find(v449, NameMon) then
                ...
                if v450 then
                            ...
                            if v456:FindFirstChild("HumanoidRootPart") and (v456:FindFirstChild("Humanoid") and (v456.Humanoid.Health > 0 and v456.Name == Mon)) then
                                if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, NameMon) then
                                    repeat
                                        ...
                                        sethiddenproperty(v448, "SimulationRadius", math.huge)
                    ...
                    CheckQuest()
                    if BypassTP then
                        local v457 = (v451.Position - CFrameQuest.Position).Magnitude
                        if v457 > 1500 then
                            BTP(CFrameQuest * CFrame.new(0, 20, 5))
                        elseif v457 < 1500 then
                            topos(CFrameQuest)
                        end
                    else
                        topos(CFrameQuest)
                    end
                    if (v451.Position - CFrameQuest.Position).Magnitude <= 20 then
        ...
        if getgenv().BonesBring then
            pcall(function()
                ...
                while true do
                    ...
                    if vu458[v462.Name] and (v462:FindFirstChild("HumanoidRootPart") and v462:FindFirstChild("Humanoid")) then
                        v462.HumanoidRootPart.CFrame = vu458[v462.Name]
                        ...
                        local v463 = v462.Humanoid:FindFirstChild("Animator")
                        if v463 then
                            v463:Destroy()
                        end
        ...
        if getgenv().CakeBring then
            pcall(function()
                ...
                while true do
                    ...
                    if vu474[v478.Name] then
                        local v479 = vu474[v478.Name]
                        if v479 then
...
spawn(function()
    local function vu495(p493, p494)
    ...
    pcall(function()
        while task.wait(0.1) do
            if GetMode == "Superhuman" and (getgenv().AutoGetMelee and World2) then
                local v553 = game.Players.LocalPlayer
                local v554 = v553.Backpack
                local v555 = v553.Character
                local v556 = v553.Data.Beli.Value
                local v557 = v553.Data.Fragments and v553.Data.Fragments.Value or 0
                if (v554:FindFirstChild("Combat") or v555:FindFirstChild("Combat")) and v556 >= 150000 then
                    UnEquipWeapon("Combat")
                    task.wait(0.1)
                    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyBlackLeg")
                end
                if v554:FindFirstChild("Superhuman") or v555:FindFirstChild("Superhuman") then
                ...
                while true do
                    ...
                    local v567 = v554:FindFirstChild(v562) or v555:FindFirstChild(v562)
                    if v567 then
                        if v567.Level.Value >= v563 then
                            if v563 <= v567.Level.Value and (v566 and v565 <= v557 or not v566 and v565 <= v556) then
                                UnEquipWeapon(v562)
                                task.wait(0.1)
                                if v566 then
    ...
    pcall(function()
        while task.wait(0.1) do
            if GetMode == "DeathStep" and (getgenv().AutoGetMelee and World2) then
                local v568 = game:GetService("Players").LocalPlayer
                local v569 = v568.Backpack
                local v570 = v568.Character
                local v571 = v569:FindFirstChild("Black Leg") or v570:FindFirstChild("Black Leg")
                if v571 or (v569:FindFirstChild("Death Step") or v570:FindFirstChild("Death Step")) then
    ...
    pcall(function()
        while task.wait(0.1) do
            if GetMode == "Sharkman Karate" and (getgenv().AutoGetMelee and World2) then
                ...
                local v573 = game:GetService("Players").LocalPlayer
                local v574 = v573.Backpack
                local v575 = v573.Character
                local v576 = v575:FindFirstChild("Water Key") or v574:FindFirstChild("Water Key")
                local v577 = v575:FindFirstChild("Fishman Karate")
                if v577 then
                    v577 = v575:FindFirstChild("Fishman Karate").Level.Value >= 400
                end
                if v572 then
                    if v576 then
                        topos(CFrame.new(- 2604.6958, 239.432526, - 10315.1982, 0.0425701365, 0, - 0.999093413, 0, 1, 0, 0.999093413, 0, 0.0425701365))
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySharkmanKarate")
                    elseif not v577 then
                        local v578 = game:GetService("Workspace").Enemies:FindFirstChild("Tide Keeper")
                        if v578 then
                            local v579 = v578:FindFirstChild("HumanoidRootPart")
                            if v579 then
                                local v580 = v579.CFrame
                                repeat
                                    task.wait(0.1)
                                    AutoHaki()
                                    EquipWeapon(getgenv().SelectWeapon)
                                    v579.CanCollide = false
                                    v579.Parent.Humanoid.WalkSpeed = 0
                                    v579.CFrame = v580
                                    topos(v579.CFrame * CFrame.new(2, 20, 2))
                                until not v579.Parent or (v579.Parent.Humanoid.Health <= 0 or (not getgenv().AutoGetMelee or v576))
                            end
                        else
...
spawn(function()
    pcall(function()
        while task.wait(0.1) do
            ...
            local v582 = v581.Backpack
            local v583 = v581.Character
            local v584 = v582:FindFirstChild("Electro") or v583:FindFirstChild("Electro")
            if not v582:FindFirstChild("Electric Claw") then
                v583:FindFirstChild("Electric Claw")
            end
            ...
            if getgenv().AutoGetMelee and (v584 and 400 <= v585) then
                if getgenv().AutoFarm then
                    if getgenv().AutoFarm then
                        ...
                        until not getgenv().AutoGetMelee or (v583.HumanoidRootPart.Position - CFrame.new(- 10371.4717, 330.764496, - 10131.4199).Position).Magnitude <= 10
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyElectricClaw", "Start")
                        task.wait(1)
                        repeat
                            task.wait(1)
                            topos(CFrame.new(- 12550.532226563, 336.22631835938, - 7510.4233398438))
                        until not getgenv().AutoGetMelee or (v583.HumanoidRootPart.Position - CFrame.new(- 12550.532226563, 336.22631835938, - 7510.4233398438).Position).Magnitude <= 10
                        task.wait(1)
                        repeat
                            task.wait(1)
                            topos(CFrame.new(- 10371.4717, 330.764496, - 10131.4199))
...
spawn(function()
    while task.wait(0.1) do
        local v586 = game:GetService("Players").LocalPlayer
        local v587 = v586.Backpack
        local v588 = v586.Character
        local v589 = v587:FindFirstChild("Dragon Claw") or v588:FindFirstChild("Dragon Claw")
        if not v587:FindFirstChild("Dragon Talon") then
            v588:FindFirstChild("Dragon Talon")
        end
    ...
    pcall(function()
        while task.wait(0.1) do
            if GetMode == "GodHuman" and (getgenv().AutoGetMelee and World3) then
                local v591 = game.Players.LocalPlayer
                local vu592 = v591.Backpack
                local vu593 = v591.Character
                local function v597(p594, p595)
					-- upvalues: (ref) vu592, (ref) vu593
                    local v596 = vu592:FindFirstChild(p594) or vu593:FindFirstChild(p594)
                    if v596 then
                ...
                if v597("Superhuman", 400) or (v597("Death Step", 400) or (v597("Sharkman Karate", 400) or (v597("Electric Claw", 400) or v597("Dragon Talon", 400)))) then
                    ...
                    elseif v597("Dragon Talon", 400) then
                        local v598 = game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyGodhuman", true)
                        if string.find(v598, "Bring") then
                            game.StarterGui:SetCore("SendNotification", {
...
local vu601 = game:GetService("Workspace")
local vu602 = game:GetService("StarterGui")
spawn(function()
	-- upvalues: (ref) vu601
    while task.wait(0.2) do
...
spawn(function()
    ...
    while true do
        ...
        if getgenv().TeleportToFruit and getgenv().TeleportToFruitHop then
            ...
            if not v614 then
                task.wait(1)
                vu602:SetCore("SendNotification", {
                    ["Title"] = "Server Hop..",
                    ["Text"] = "",
                    ["Duration"] = 5
                })
...
spawn(function()
    while task.wait(0.1) do
        if getgenv().AutoNewWorld and World1 then
            spawn(function()
                local v617 = game:GetService("Players").LocalPlayer
                local v618 = game:GetService("Workspace")
                local v619 = game:GetService("ReplicatedStorage")
                if v617.Data.Level.Value >= 700 and World1 then
                    local v620 = v618.Map.Ice.Door
                    if v620.CanCollide ~= false or v620.Transparency ~= 1 then
                        if v618.Enemies:FindFirstChild("Ice Admiral [Lv. 700] [Boss]") then
                            local v621, v622, v623 = pairs(v618.Enemies:GetChildren())
                            while true do
                                local v624
                                ...
                                if v624.Name == "Ice Admiral" and (v624:FindFirstChild("Humanoid") and v624:FindFirstChild("HumanoidRootPart")) then
                                    local v625 = v624.HumanoidRootPart.CFrame
                                    repeat
                                        task.wait(0.05)
                                        AutoHaki()
                                        EquipWeapon(getgenv().SelectWeapon)
                                        ...
                                        v624.HumanoidRootPart.CFrame = v625
                                        topos(v624.HumanoidRootPart.CFrame * Pos)
                                    until not getgenv().AutoNewWorld or (not v624.Parent or v624.Humanoid.Health <= 0)
                                end
                            end
                        elseif v619:FindFirstChild("Ice Admiral") then
                            topos(v619:FindFirstChild("Ice Admiral").HumanoidRootPart.CFrame * CFrame.new(5, 10, 7))
                        else
                            v619.Remotes.CommF_:InvokeServer("TravelDressrosa")
                        end
                    else
                        ...
                        repeat
                            topos(v626)
                            task.wait(0.1)
                        until (v626.Position - v617.Character.HumanoidRootPart.Position).Magnitude <= 3 or not getgenv().AutoNewWorld
                        task.wait(1.1)
                        v619.Remotes.CommF_:InvokeServer("DressrosaQuestProgress", "Detective")
                        task.wait(0.1)
                        EquipWeapon("Key")
                        ...
                        repeat
                            topos(v627)
                            task.wait(0.1)
                        until (v627.Position - v617.Character.HumanoidRootPart.Position).Magnitude <= 3 or not getgenv().AutoNewWorld
                        task.wait(0.1)
                    end
                end
            end)
...
spawn(function()
    while task.wait(0.1) do
        if getgenv().AutoThirdSea and World2 then
            pcall(function()
                local v629 = game:GetService("Players").LocalPlayer
                local v630 = game:GetService("ReplicatedStorage")
                local v631 = game:GetService("Workspace").Enemies
                if v629.Data.Level.Value >= 1500 and World2 then
                    getgenv().AutoFarm = false
                    if v630.Remotes.CommF_:InvokeServer("ZQuestProgress", "General") == 0 then
                        topos(CFrame.new(- 1926.322, 12.82, 1738.309))
                        if (CFrame.new(- 1926.322, 12.82, 1738.309).Position - v629.Character.HumanoidRootPart.Position).Magnitude <= 10 then
                            task.wait(1.1)
                            v630.Remotes.CommF_:InvokeServer("ZQuestProgress", "Begin")
                        end
                        task.wait(1.3)
                        if v631:FindFirstChild("rip_indra [Lv. 1500] [Boss]") then
                            local v632, v633, v634 = pairs(v631:GetChildren())
                            while true do
                                local v635
                                ...
                                if v635.Name == "rip_indra" and (v635:FindFirstChild("Humanoid") and (v635:FindFirstChild("HumanoidRootPart") and v635.Humanoid.Health > 0)) then
                                    local v636 = v635.HumanoidRootPart.CFrame
                                    repeat
                                        task.wait(0.05)
                                        AutoHaki()
                                        EquipWeapon(getgenv().SelectWeapon)
                                        topos(v635.HumanoidRootPart.CFrame * Pos)
                                        v635.HumanoidRootPart.CFrame = v636
                                        v635.HumanoidRootPart.CanCollide = false
                                        v635.Humanoid.WalkSpeed = 0
                                        v630.Remotes.CommF_:InvokeServer("TravelZou")
                                    until not getgenv().AutoThirdSea or (v635.Humanoid.Health <= 0 or not v635.Parent)
                                end
                            end
                        elseif not v631:FindFirstChild("rip_indra") and (CFrame.new(- 26880.934, 22.849, 473.19).Position - v629.Character.HumanoidRootPart.Position).Magnitude <= 1000 then
...
task.spawn(function()
    while task.wait(0.1) do
        if getgenv().AutoFactory and World2 then
            local v638 = game:GetService("Workspace").Enemies:FindFirstChild("Core")
            if v638 and v638.Humanoid.Health > 0 then
                repeat
                    task.wait(0.1)
                    AutoHaki()
                    EquipWeapon(getgenv().SelectWeapon)
                    topos(v638.HumanoidRootPart.CFrame)
                until v638.Humanoid.Health <= 0 or not getgenv().AutoFactory
            else
    ...
    while task.wait(0.1) do
        if getgenv().AutoPirateRaid and World3 then
            pcall(function()
                ...
                local v641 = game.Players.LocalPlayer
                local v642 = v641.Character
                if v642 then
                    v642 = v641.Character:FindFirstChild("HumanoidRootPart")
                end
                if v642 then
                    if (CFrame.new(- 5539.311, 313.801, - 2972.372).Position - v642.Position).Magnitude > 500 then
                        UnEquipWeapon(getgenv().SelectWeapon)
                        if BypassTP then
                            local v643 = (v642.Position - v640.Position).Magnitude
                            if v643 > 1500 then
                                BTP(v640)
                            elseif v643 <= 1500 then
                                topos(v640)
                            end
                        end
                        ...
                        while true do
                            ...
                            if getgenv().AutoPirateRaid and (v647:FindFirstChild("HumanoidRootPart") and (v647:FindFirstChild("Humanoid") and (v647.Humanoid.Health > 0 and (v647.HumanoidRootPart.Position - v642.Position).Magnitude < 2000))) then
                                repeat
                                    task.wait(0.1)
                                    AutoHaki()
                                    EquipWeapon(getgenv().SelectWeapon)
    ...
    while task.wait(0.3) do
        if getgenv().AutoEliteHunter and World3 then
            pcall(function()
                ...
                if v650.Visible ~= true then
                    local v651 = game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("EliteHunter")
                    if getgenv().AutoEliteHunterHop and v651 == "I don\'t have anything for you right now. Come back later." then
                        Hop()
                    end
                else
                    local _ = v650.Container.QuestTitle.Title.Text
    ...
    pcall(function()
        while task.wait(1) do
            if getgenv().AutoRipIndra and World3 then
                local v668 = game:GetService("Workspace").Enemies
                local v669 = game:GetService("Players").LocalPlayer
                if v668:FindFirstChild("rip_indra True Form") or v668:FindFirstChild("rip_indra") then
                    local v670, v671, v672 = pairs(v668:GetChildren())
                    while true do
                        local vu673
                        v672, vu673 = v670(v671, v672)
                        if v672 == nil then
                            break
                        end
                        if (vu673.Name == "rip_indra True Form" or vu673.Name == "rip_indra") and (vu673.Humanoid.Health > 0 and (vu673:IsA("Model") and (vu673:FindFirstChild("Humanoid") and vu673:FindFirstChild("HumanoidRootPart")))) then
                            repeat
                                task.wait(0.3)
                                pcall(function()
									-- upvalues: (ref) vu673
                                    AutoHaki()
                                    EquipWeapon(getgenv().SelectWeapon)
                                    vu673.HumanoidRootPart.CanCollide = false
                                    vu673.Humanoid.WalkSpeed = 0
                                    topos(vu673.HumanoidRootPart.CFrame * Pos)
                                end)
                            until getgenv().AutoRipIndra == false or vu673.Humanoid.Health <= 0
                        end
                    end
                elseif v669.Backpack:FindFirstChild("God\'s Chalice") or v669.Character:FindFirstChild("God\'s Chalice") then
                    repeat
                        task.wait(0.3)
                        topos(CFrame.new(- 5563.75048828125, 320.4276123046875, - 2662.509521484375))
                        EquipWeapon("God\'s Chalice")
                    until not (v669.Backpack:FindFirstChild("God\'s Chalice") or v669.Character:FindFirstChild("God\'s Chalice"))
                elseif game:GetService("ReplicatedStorage"):FindFirstChild("rip_indra True Form") then
                    local v674 = game:GetService("ReplicatedStorage"):FindFirstChild("rip_indra True Form")
                    topos(v674.HumanoidRootPart.CFrame * Pos)
                end
            end
        end
    end)
...
spawn(function()
    while true do
        if getgenv().AutoSoulReaper and World3 then
            pcall(function()
                local v676 = game:GetService("Workspace").Enemies
                local v677 = game:GetService("ReplicatedStorage")
                local v678 = game:GetService("Players").LocalPlayer
                local v679 = v678.Backpack
                local v680 = v678.Character
                local v681
                if v680 then
                    v681 = v680:FindFirstChild("HumanoidRootPart")
                else
                    v681 = v680
                end
                if v676:FindFirstChild("Soul Reaper") then
                    local v682, v683, v684 = pairs(v676:GetChildren())
                    while true do
                        local v685
                ...
                elseif v679:FindFirstChild("Hallow Essence") or v680:FindFirstChild("Hallow Essence") then
                    ...
                    local v687 = v677:FindFirstChild("Soul Reaper")
                    if v687 then
                        topos(v687.HumanoidRootPart.CFrame * CFrame.new(2, 20, 2))
                    end
                end
            end)
        end
    ...
    while task.wait(0.1) do
        if getgenv().AutoDarkbeard and World2 then
            pcall(function()
                ...
                local v711 = game:GetService("Players").LocalPlayer
                if v710:FindFirstChild("Darkbeard") then
                    local v712, v713, v714 = pairs(v710:GetChildren())
                    while true do
                        local v715
                ...
                if v711.Backpack:FindFirstChild("Fist of Darkness") or v711.Character:FindFirstChild("Fist of Darkness") then
                    task.wait(0.1)
...
local vu717 = CFrame.new(5855.19629, 1208.32178, 872.713501, 0.606994748, - 1.81058823e-9, - 0.794705868, 5.72712722e-9, 1, 2.09605577e-9, 0.794705868, - 5.82367621e-9, 0.606994748)
spawn(function()
	-- upvalues: (ref) vu717
    while task.wait(0.2) do
        if getgenv().DojoClaimQuest and World3 then
            pcall(function()
                ...
                if (vu717.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 5 then
...
spawn(function()
    while task.wait(0.2) do
        if getgenv().DragonTalonUpgrade and World3 then
            local v719 = CFrame.new(5661.89014, 1211.31909, 864.836731, 0.811413169, - 1.36805838e-8, - 0.584473014, 4.75227395e-8, 1, 4.25682458e-8, 0.584473014, - 6.23161966e-8, 0.811413169)
...
spawn(function()
    while task.wait(0.2) do
        if getgenv().BlazeEmberFarm and World3 then
            pcall(function()
				-- block 36
                local v721 = game:GetService("Workspace").Enemies
                game.Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart")
                if not (v721:FindFirstChild("Ghost") or (v721:FindFirstChild("Hydra Enforcer") or v721:FindFirstChild("Venomous Assailant"))) then
                ...
                local v722, v723, v724 = pairs(v721:GetChildren())
				-- ::l8::
                while true do
                    local v725
        ...
        if v727 then
            ...
            while true do
                ...
                if v731:IsA("Model") and v731.PrimaryPart then
                    local v732 = v731.PrimaryPart.Position
                    if (v732 - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude > 1 then
                        topos(CFrame.new(v732))
                    else
...
spawn(function()
    ...
    while wait(0.2) do
        if getgenv().AutoFarmChest then
            local v735 = game:GetService("Players").LocalPlayer
            local v736 = (v735.Character or v735.CharacterAdded:Wait()):GetPivot().Position
            local v737 = game:GetService("CollectionService"):GetTagged("_ChestTagged")
            local v738 = math.huge
            local v739, v740, v741 = ipairs(v737)
            local v742 = nil
            while true do
                local v743
                ...
                if not v743:GetAttribute("IsDisabled") then
                    local v744 = (v743:GetPivot().Position - v736).Magnitude
                    if v744 < v738 then
                        v742 = v743
                        v738 = v744
                    end
...
spawn(function()
    while task.wait(0.5) do
        ...
        if v748 then
            local v749 = v748:FindFirstChild("Backpack")
            local v750 = v748.Character
            if v749 and (v750 and (v749:FindFirstChild("Fist of Darkness") or (v750:FindFirstChild("Fist of Darkness") or (v749:FindFirstChild("God\'s Chalice") or v750:FindFirstChild("God\'s Chalice"))))) then
...
spawn(function()
    local vu751 = game:GetService("Players").LocalPlayer.VisionRadius.Value
    while wait(0.1) do
        pcall(function()
			-- upvalues: (ref) vu751
            local v752 = game:GetService("Players").LocalPlayer.VisionRadius.Value
            if v752 ~= vu751 then
                ObservationRange:SetDesc("Observation Range Level: " .. math.floor(v752))
                vu751 = v752
            end
        end)
    end
...
spawn(function()
    ...
    while true do
        ...
        pcall(function()
			-- upvalues: (ref) vu763
            if getgenv().AutoObservationHakiV2 and (World3 and (sethiddenproperty and tick() - vu763 >= 1)) then
                sethiddenproperty(game.Players.LocalPlayer, "SimulationRadius", math.huge)
                vu763 = tick()
            end
        end)
    ...
    game:GetService("RunService").Heartbeat:Connect(function()
        pcall(function()
            if getgenv().AutoObservationHakiV2 and World3 then
                local v764 = game:GetService("Players").LocalPlayer.Character
                if v764 and v764:FindFirstChild("Humanoid") then
                    local v765 = v764.Humanoid
                    if v765:GetState() ~= Enum.HumanoidStateType.Physics then
                        v765:ChangeState(Enum.HumanoidStateType.Physics)
                    end
                end
            end
        end)
            ...
            if getgenv().AutoObservationHakiV2 and getgenv().StartMagnet then
                ...
                while true do
                    ...
                    if v770.Name == "Forest Pirate" and (v770:FindFirstChild("Humanoid") and v770.Humanoid.Health > 0) then
                        local v771 = v770.HumanoidRootPart
                        if v771.CanCollide ~= false then
                            v771.CanCollide = false
                        end
                        if v771.Size ~= Vector3.new(50, 50, 50) then
                            v771.Size = Vector3.new(50, 50, 50)
                        end
                        if v771.CFrame ~= PosHee then
                            v771.CFrame = PosHee
                        end
                    end
                end
            ...
            if getgenv().AutoObservationHakiV2 and getgenv().StartMagnet then
                ...
                while true do
                    ...
                    if v776.Name == Ms and v776:FindFirstChild("Humanoid") then
                        local v777 = v776.Humanoid
                        if v777.Health > 0 then
                            v777:ChangeState(11)
                            task.wait(0.1)
                            v777:ChangeState(14)
                        end
...
spawn(function()
    pcall(function()
        ...
        local v779 = nil
        local v780 = nil
        local v781 = game:GetService("Players").LocalPlayer
        local v782 = game:GetService("Workspace").Enemies
        local v783 = v781.PlayerGui.ScreenGui
        if World2 then
        ...
        local v784 = v782:FindFirstChild(v779)
        if not v784 then
			-- goto l20
        end
        if not v783:FindFirstChild("ImageLabel") then
			-- goto l23
        end
        task.wait(0.1)
        v781.Character.HumanoidRootPart.CFrame = v784.HumanoidRootPart.CFrame * CFrame.new(3, 0, 0)
        if getgenv().AutoObservation and v783:FindFirstChild("ImageLabel") then
			-- goto l23
        end
		-- goto l0
		-- ::l20::
		...
		-- ::l23::
        task.wait(0.1)
        v781.Character.HumanoidRootPart.CFrame = v784.HumanoidRootPart.CFrame * CFrame.new(0, 50, 0)
        if not v783:FindFirstChild("ImageLabel") and getgenv().AutoObservation_Hop then
            game:GetService("TeleportService"):Teleport(game.PlaceId, v781)
        end
        if getgenv().AutoObservation and not v783:FindFirstChild("ImageLabel") then
			-- goto l23
        else
			-- goto l0
        end
...
spawn(function()
    while task.wait(0.2) do
        if getgenv().AutoFarmBoss and getgenv().BypassTP then
            pcall(function()
				-- block 37
                local v787 = game:GetService("Workspace").Enemies
                local v788 = getgenv().SelectBoss
                local _ = getgenv().SelectWeapon
                local v789 = game.Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart")
                if not v787:FindFirstChild(v788) then
                    if game.ReplicatedStorage:FindFirstChild(v788) then
                        local v790 = game.ReplicatedStorage:FindFirstChild(v788).HumanoidRootPart
                        if (v790.CFrame.Position - v789.Position).Magnitude > 1500 then
                            BTP(v790.CFrame)
                        else
                            topos(v790.CFrame)
                        end
                ...
                local v791, v792, v793 = pairs(v787:GetChildren())
				-- ::l4::
                local v794
                ...
                if v794.Name ~= v788 or not (v794:FindFirstChild("Humanoid") and v794:FindFirstChild("HumanoidRootPart")) then
					-- goto l4
                else
					-- goto l2
                end
				-- ::l2::
				-- ::l11::
                local v795 = v794.Humanoid
                local v796 = v794.HumanoidRootPart
                if v795.Health <= 0 then
					-- goto l4
                end
				-- ::l13::
                task.wait()
                AutoHaki()
                EquipWeapon(getgenv().SelectWeapon)
                if v796.CanCollide then
                    v796.CanCollide = false
                end
                if v795.WalkSpeed ~= 0 then
                    v795.WalkSpeed = 0
                end
                if v796.Size ~= Vector3.new(80, 80, 80) then
                    v796.Size = Vector3.new(80, 80, 80)
                end
                topos(v796.CFrame * Pos)
                if getgenv().AutoFarmBoss and (v794.Parent and v795.Health > 0) then
					-- goto l13
                else
					-- goto l4
                end
...
spawn(function()
    while task.wait(0.2) do
        if getgenv().AutoFarmBoss and not getgenv().BypassTP then
            pcall(function()
				-- block 34
                local v797 = game:GetService("Workspace").Enemies
                local v798 = getgenv().SelectBoss
                local _ = getgenv().SelectWeapon
                if not v797:FindFirstChild(v798) then
                    local v799 = game:GetService("ReplicatedStorage"):FindFirstChild(v798)
                    if v799 then
                ...
                local v800, v801, v802 = pairs(v797:GetChildren())
				-- ::l4::
                local v803
                ...
                if v803.Name ~= v798 or not (v803:FindFirstChild("Humanoid") and v803:FindFirstChild("HumanoidRootPart")) then
					-- goto l4
                else
					-- goto l2
                end
				-- ::l2::
				-- ::l11::
                local v804 = v803.Humanoid
                local v805 = v803.HumanoidRootPart
                if v804.Health <= 0 then
					-- goto l4
                end
				-- ::l13::
                task.wait()
                AutoHaki()
                EquipWeapon(getgenv().SelectWeapon)
                if v805.CanCollide then
                    v805.CanCollide = false
                end
                if v804.WalkSpeed ~= 0 then
                    v804.WalkSpeed = 0
                end
                if v805.Size ~= Vector3.new(80, 80, 80) then
                    v805.Size = Vector3.new(80, 80, 80)
                end
                topos(v805.CFrame * Pos)
                if getgenv().AutoFarmBoss and (v803.Parent and v804.Health > 0) then
					-- goto l13
                else
					-- goto l4
                end
...
spawn(function()
    while task.wait(0.2) do
        if getgenv().AutoStoreFruit then
            pcall(function()
                if getgenv().AutoStoreFruit then
                    local v817 = game:GetService("Players").LocalPlayer
                    local v818 = v817.Character
                    local v819 = v817.Backpack
                    ...
                    while true do
                        ...
                        local v824 = v823[1]
                        local v825 = v823[2]
                        if v818:FindFirstChild(v824) or v819:FindFirstChild(v824) then
                            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit", v825, v819:FindFirstChild(v824))
                        end
                    end
                end
            end)
    ...
    while task.wait(1) do
        if getgenv().Auto_Dungeon then
            ...
            while true do
                ...
                if vu843:FindFirstChild("Humanoid") and (vu843:FindFirstChild("HumanoidRootPart") and vu843.Humanoid.Health > 0) then
                    pcall(function()
						-- upvalues: (ref) vu843
                        repeat
                            task.wait(0.001)
                            vu843.Humanoid.Health = 0
                            vu843.HumanoidRootPart.CanCollide = false
                            sethiddenproperty(game.Players.LocalPlayer, "SimulationRadius", math.huge)
                        until not getgenv().Auto_Dungeon or (not vu843.Parent or vu843.Humanoid.Health <= 0)
                    end)
                end
            end
        end
...
function CheckBoat()
    local v869 = game:GetService("Workspace"):FindFirstChild("Boats")
    local v870 = getgenv().SelectedBoat
    if not (v869 and v870) then
        return false
    end
    local v871, v872, v873 = pairs(v869:GetChildren())
    while true do
        local v874
        ...
        if v874.Name == v870 and v874:FindFirstChild("MyBoatEsp") then
            return v874
        end
    end
    return false
...
function CheckEnemiesBoat()
    local v875 = game:GetService("Workspace"):FindFirstChild("Enemies")
    if v875 then
        return v875:FindFirstChild("FishBoat") or (v875:FindFirstChild("PirateBrigade") or v875:FindFirstChild("PirateGrandBrigade") and true or false)
    else
        return false
    end
end
function CheckShark()
    local v876 = game:GetService("Workspace"):FindFirstChild("Enemies")
    local v877 = game.Players.LocalPlayer
    if v877 then
        v877 = v877.Character
    end
    if v877 then
        v877 = v877:FindFirstChild("HumanoidRootPart")
    end
    if not (v876 and v877) then
        return false
    end
    local v878, v879, v880 = pairs(v876:GetChildren())
    while true do
        local v881
        ...
        local v882 = v881:FindFirstChild("Humanoid")
        local v883 = v881:FindFirstChild("HumanoidRootPart")
        if v881.Name == "Shark" and (v882 and (v883 and (v882.Health > 0 and (v883.Position - v877.Position).Magnitude <= 200))) then
            return true
        end
    end
    return false
...
function CheckPiranha()
    local v884 = game:GetService("Workspace"):FindFirstChild("Enemies")
    local v885 = game.Players.LocalPlayer
    if v885 then
        v885 = v885.Character
    end
    if v885 then
        v885 = v885:FindFirstChild("HumanoidRootPart")
    end
    if not (v884 and v885) then
        return false
    end
    local v886, v887, v888 = pairs(v884:GetChildren())
    while true do
        local v889
        ...
        local v890 = v889:FindFirstChild("Humanoid")
        local v891 = v889:FindFirstChild("HumanoidRootPart")
        if v889.Name == "Piranha" and (v890 and (v891 and (v890.Health > 0 and (v891.Position - v885.Position).Magnitude <= 200))) then
            return true
        end
    end
    return false
...
function AddEsp(p892, p893)
    if p893 and p893:IsA("Instance") then
        local v894 = Instance.new("BillboardGui")
        local v895 = Instance.new("TextLabel")
        v894.Name = p892
        v894.Parent = p893
        v894.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
        v894.AlwaysOnTop = true
        v894.Size = UDim2.new(0, 200, 0, 50)
        v894.StudsOffset = Vector3.new(0, 2.5, 0)
        v895.Parent = v894
        v895.BackgroundTransparency = 1
        v895.Size = UDim2.new(1, 0, 1, 0)
        v895.Font = Enum.Font.GothamBold
        v895.TextColor3 = Color3.new(1, 1, 1)
        v895.TextSize = 15
        v895.Text = "YOUR BOAT IS HERE\226\134\147"
        return v894
    end
end
spawn(function()
...
spawn(function()
    pcall(function()
        while task.wait(0.2) do
            if getgenv().SailBoat then
                local v904 = game:GetService("Workspace").Enemies
                if CheckShark() and getgenv().AutoKillShark and true or (v904:FindFirstChild("Terrorshark") and getgenv().AutoTerrorshark and true or (CheckPiranha() and getgenv().AutoKillPiranha and true or (v904:FindFirstChild("Fish Crew Member") and getgenv().AutoKillFishCrew and true or (v904:FindFirstChild("FishBoat") and getgenv().RelzFishBoat and true or (v904:FindFirstChild("PirateBrigade") and getgenv().RelzPirateBrigade and true or (v904:FindFirstChild("PirateGrandBrigade") and getgenv().RelzPirateGrandBrigade and true or (CheckSeaBeast() and getgenv().AutoSeaBest and true or false))))))) then
                    local v905 = game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")
                    if v905 and v905.Sit then
                        local v906 = game:GetService("VirtualInputManager")
                        v906:SendKeyEvent(true, 32, false, game)
                        task.wait(0.1)
                        v906:SendKeyEvent(false, 32, false, game)
                    end
                end
            end
        end
    ...
    while task.wait(0.1) do
        pcall(function()
            ...
            while true do
                ...
                local v912 = v911.Engine.CFrame
				-- ::l48::
                task.wait()
                local v913 = game.Players.LocalPlayer.Character.HumanoidRootPart.Position
                if (v912.Position - v913).Magnitude > 5 then
                    topos(v912)
                end
                getgenv().SeaSkill = (v912.Position - v913).Magnitude <= 50
                Skillaimbot = true
                AimBotSkillPosition = v912.Position + Vector3.new(0, - 15, 0)
            ...
            AutoHaki()
            EquipWeapon(getgenv().SelectWeapon)
            local v914 = game.Players.LocalPlayer.Character.HumanoidRootPart.Position
            if (v916.HumanoidRootPart.Position - v914).Magnitude > 5 then
...
spawn(function()
    while task.wait(0.1) do
        pcall(function()
			...
			-- ::l46::
            task.wait()
            local v929 = game.Players.LocalPlayer.Character.HumanoidRootPart.Position
            getgenv().SeaSkill = (v927.Position - v929).Magnitude <= 50
            if (v927.Position - v929).Magnitude > 5 then
                topos(v927)
            end
            Skillaimbot = true
            AimBotSkillPosition = v927.Position + Vector3.new(0, - 15, 0)
...
spawn(function()
    while task.wait(0.1) do
        pcall(function()
			-- block 109
            local v933 = game.Players.LocalPlayer
            if v933 then
                v933 = v933.Character
            end
            local v934
            if v933 then
                v934 = v933:FindFirstChild("HumanoidRootPart")
            else
                v934 = v933
            end
            if not v934 then
            ...
            if true then
                ...
                if v933.Humanoid.Health >= 2000 then
    ...
    while task.wait(0.1) do
        pcall(function()
            if getgenv().AutoTerrorshark then
                local v952 = game.Players.LocalPlayer
                if v952 then
                    v952 = v952.Character
                end
                if v952 then
                    v952 = v952:FindFirstChild("HumanoidRootPart")
                end
                if not v952 then
                    return
                end
                local v953 = game:GetService("Workspace").Enemies:FindFirstChild("Terrorshark")
                if v953 and (v953:FindFirstChild("HumanoidRootPart") and (v953.HumanoidRootPart.Position - v952.Position).Magnitude <= 150) then
                    repeat
                        task.wait()
            ...
            while true do
                ...
                if v961.Name == "FishBoat" and v961:FindFirstChild("Engine") then
                    repeat
                        ...
                        local v963 = game.Players.LocalPlayer
                        if v963 then
                            v963 = v963.Character
                        end
                        if v963 then
                            v963 = v963:FindFirstChild("HumanoidRootPart")
                        end
                        if v963 and (v961.Engine.Position - v963.Position).Magnitude <= 50 then
                            getgenv().SeaSkill = true
                        else
                            getgenv().SeaSkill = false
                        end
                        if v963 and (v963.Position - v962.Position).Magnitude > 2 then
                            topos(v962)
                        end
                        Skillaimbot = true
...
function CheckSeaBeast()
    local v966 = game:GetService("Workspace"):FindFirstChild("SeaBeasts")
    if not v966 then
        return false
    end
    local v967, v968, v969 = ipairs(v966:GetChildren())
    while true do
        local v970
        ...
        local v971 = v970:FindFirstChild("Humanoid")
        if v971 and (v970:FindFirstChild("HumanoidRootPart") and v971.Health > 0) then
            return true
        end
    end
    return false
...
task.spawn(function()
    while task.wait(0.5) do
        if getgenv().AutoSeaBest then
            pcall(function()
				-- block 24
                local v972 = game:GetService("Workspace")
                local v973 = game.Players.LocalPlayer
                if not v972:FindFirstChild("SeaBeasts") then
					-- ::l3::
                    return
                end
                local v974, v975, v976 = pairs(v972.SeaBeasts:GetChildren())
				-- goto l4
				-- ::l14::
                Skillaimbot = false
                getgenv().SeaSkill = false
                ...
                if true then
                    ...
                    if (CFrameSeaBeast.Position - v973.Character.HumanoidRootPart.CFrame.Position).Magnitude > 50 then
                        getgenv().SeaSkill = false
                    else
                        getgenv().SeaSkill = true
                    end
...
local function vu980(p978, p979)
    ...
    while task.wait(1) do
        pcall(function()
            ...
            if getgenv().SeaSkill then
                local v981 = game.Players.LocalPlayer
                local v982 = v981.Backpack
                if getgenv().UseSeaFruitSkill and not DoneSkillFruit then
                    local v983, v984, v985 = pairs(v982:GetChildren())
                    while true do
                        local v986
                        ...
                        if v986:IsA("Tool") and v986.ToolTip == "Blox Fruit" then
                            v981.Character.Humanoid:EquipTool(v986)
                        end
                    end
                    if getgenv().SkillFruitZ then
                        vu980("Z", getgenv().SeaHoldSKillZ)
                    end
                    if getgenv().SkillFruitX then
                        vu980("X", getgenv().SeaHoldSKillX)
                    end
                    if getgenv().SkillFruitC then
                        vu980("C", getgenv().SeaHoldSKillC)
                    end
                    if getgenv().SkillFruitV then
                        vu980("V", getgenv().SeaHoldSKillV)
                    end
                    if getgenv().SkillFruitF then
                        vu980("F", getgenv().SeaHoldSKillF)
                    end
                    DoneSkillFruit = true
                end
                if getgenv().UseSeaMeleeSkill and not DoneSkillMelee then
                    local v987, v988, v989 = pairs(v982:GetChildren())
                    while true do
                        local v990
                        ...
                        if v990:IsA("Tool") and v990.ToolTip == "Melee" then
                            v981.Character.Humanoid:EquipTool(v990)
                        end
                    end
                ...
                if getgenv().UseSeaSwordSkill and not DoneSkillSword then
                    local v991, v992, v993 = pairs(v982:GetChildren())
                    while true do
                        local v994
                        ...
                        if v994:IsA("Tool") and v994.ToolTip == "Sword" then
                            v981.Character.Humanoid:EquipTool(v994)
                        end
                    end
                ...
                if getgenv().UseSeaGunSkill and not DoneSkillGun then
                    local v995, v996, v997 = pairs(v982:GetChildren())
                    while true do
                        local v998
                        ...
                        if v998:IsA("Tool") and v998.ToolTip == "Gun" then
                            v981.Character.Humanoid:EquipTool(v998)
                        end
                    end
...
spawn(function()
    while wait() do
        ...
        if v1000 then
            local v1001 = v1000.ShrineActive.NeonShrinePart
            topos(v1001.CFrame * CFrame.new(0, 0, 10))
        end
    end
end)
Sea:AddToggle("Toggle", {
...
spawn(function()
    while task.wait(0.6) do
        if getgenv().SummonKitsume and World3 then
            pcall(function()
                local v1003 = game:GetService("ReplicatedStorage")
                local v1004 = v1003:FindFirstChild("Modules")
                if v1004 then
                    v1004 = v1003.Modules:FindFirstChild("Net")
                end
                if v1004 then
                    v1004 = v1004:FindFirstChild("RF/KitsuneStatuePray")
                end
                if v1004 then
                    v1004:InvokeServer()
                end
...
task.spawn(function()
    while task.wait(1) do
        if getgenv().CollectAzure then
            pcall(function()
                local v1006 = game:GetService("Workspace"):FindFirstChild("AttachedAzureEmber")
                local v1007 = game:GetService("Workspace"):FindFirstChild("EmberTemplate")
                if v1006 and v1007 then
                    local v1008 = v1007:FindFirstChild("Part")
                    if v1008 and (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - v1008.Position).Magnitude > 10 then
                        fastpos(v1008.CFrame)
                    end
                end
            end)
        end
...
function GetCountMaterials(p1011)
    local v1012 = game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("getInventory")
    local v1013, v1014, v1015 = pairs(v1012)
    while true do
        local v1016
...
task.spawn(function()
    while task.wait(1) do
        pcall(function()
            ...
            if v1018 then
                local v1019 = v1018.Center.Position
                if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - Vector3.new(v1019.X, 500, v1019.Z)).Magnitude > 10 then
...
v1039.__namecall = newcclosure(function(...)
    ...
    return vu1040(unpack(v1042))
end)
local function vu1045(p1043, p1044)
            ...
            if vu980 then
                ...
                while true do
                    ...
                    if v1049.Name == MonFarm and (v1049:FindFirstChild("Humanoid") and (v1049:FindFirstChild("HumanoidRootPart") and v1049.Humanoid.Health <= v1049.Humanoid.MaxHealth * getgenv().Kill_At / 100)) then
                        if getgenv().SkillZ then
                            vu1045("Z", getgenv().HoldSKillZ)
                        end
                        if getgenv().SkillX then
                            vu1045("X", getgenv().HoldSKillX)
                        end
                        if getgenv().SkillC then
                            vu1045("C", getgenv().HoldSKillC)
                        end
                    end
                end
            end
...
spawn(function()
    ...
    while wait() do
        ...
        if v1064 then
            local v1065 = v1064:FindFirstChild("Core")
            if v1065 then
                v1065 = v1064.Core:FindFirstChild("PrehistoricRelic")
            end
            if v1065 then
                v1065 = v1065:FindFirstChild("Skull")
            end
            if v1065 then
                topos(CFrame.new(v1065.Position))
...
local function vu1075()
    pcall(function()
        local v1069 = game.Workspace.Map.PrehistoricIsland.Core:FindFirstChild("InteriorLava")
        if v1069 and v1069:IsA("Model") then
            v1069:Destroy()
        end
        local v1070 = game.Workspace.Map:FindFirstChild("PrehistoricIsland")
        if v1070 then
            local v1071, v1072, v1073 = pairs(v1070:GetDescendants())
            while true do
                local v1074
...
local function vu1083()
    local v1076 = game.Workspace.Map.PrehistoricIsland.Core:FindFirstChild("VolcanoRocks")
    if not v1076 then
        return nil
    end
    local v1077, v1078, v1079 = pairs(v1076:GetChildren())
    while true do
        local v1080
        ...
        if v1080:IsA("Model") then
            local v1081 = v1080:FindFirstChild("volcanorock")
            if v1081 and v1081:IsA("MeshPart") then
                local v1082 = v1081.Color
                if v1082 == Color3.fromRGB(185, 53, 56) or v1082 == Color3.fromRGB(185, 53, 57) then
                    return v1081
                end
            end
        end
...
local function vu1095(p1084)
	-- upvalues: (ref) vu1068
    local v1085 = game.Players.LocalPlayer
    local v1086 = v1085:FindFirstChild("Backpack")
    if not v1086 then
        return
    end
    ...
    while true do
        ...
        if v1090:IsA("Tool") and v1090.ToolTip == p1084 then
            ...
            while true do
                local vu1094
                v1093, vu1094 = v1091(v1092, v1093)
                if v1093 == nil then
                    break
                end
                wait(0.1)
                pcall(function()
					-- upvalues: (ref) vu1068, (ref) vu1094
                    vu1068(vu1094)
                end)
            end
            v1090.Parent = v1086
...
spawn(function()
	-- upvalues: (ref) vu1075, (ref) vu1083, (ref) vu1095
    while wait(0.1) do
        if getgenv().AutoDefendVolcano then
            ...
            if v1096 then
                ...
                if v1096.Color == Color3.fromRGB(185, 53, 56) or v1096.Color == Color3.fromRGB(185, 53, 57) then
                    local v1098 = game.Players.LocalPlayer.Character
                    if v1098 then
                        v1098 = v1098:FindFirstChild("HumanoidRootPart")
                    end
                    if v1098 and (v1098.Position - v1096.Position).Magnitude <= 1 then
        ...
        if getgenv().KillAura then
            pcall(function()
                ...
                while true do
                    ...
                    local v1104 = v1103:FindFirstChild("Humanoid")
                    local v1105 = v1103:FindFirstChild("HumanoidRootPart")
                    if v1104 and (v1105 and v1104.Health > 0) then
                        v1104.Health = 0
...
spawn(function()
	-- upvalues: (ref) vu1126
    local v1127 = workspace:WaitForChild("Map"):FindFirstChild("PrehistoricIsland")
    if v1127 then
        v1127 = v1127:FindFirstChild("TrialTeleport")
    end
    while task.wait(0.5) do
        if getgenv().TrialTeleportDraco and (v1127 and v1127:IsA("Part")) then
            vu1126(CFrame.new(v1127.Position))
        end
    end
end)
Race:AddParagraph({
    ...
    pcall(function()
        while task.wait(0.2) do
            if getgenv().UpgradeRaceV2 and World2 then
                local v1129 = game:GetService("Players").LocalPlayer
                local v1130 = v1129.Character
                if v1130 then
                    v1130 = v1129.Character:FindFirstChild("HumanoidRootPart")
                end
                local v1131 = v1129.Backpack
                if not v1129.Data.Race:FindFirstChild("Evolved") then
                    local v1132 = game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Alchemist", "1")
                    if v1132 == 0 then
                        local v1133 = CFrame.new(- 2779.83521, 72.9661407, - 3574.02002)
                        if v1130 and (v1133.Position - v1130.Position).Magnitude > 4 then
                            topos(v1133)
                        else
                            task.wait(1.1)
                    ...
                    elseif v1132 == 1 then
                        if v1131:FindFirstChild("Flower 1") or v1129.Character:FindFirstChild("Flower 1") then
                            if v1131:FindFirstChild("Flower 2") or v1129.Character:FindFirstChild("Flower 2") then
                                if not (v1131:FindFirstChild("Flower 3") or v1129.Character:FindFirstChild("Flower 3")) then
                                        ...
                                        while true do
                                            ...
                                            if v1137.Name == "Zombie" and (v1137:FindFirstChild("HumanoidRootPart") and v1137:FindFirstChild("Humanoid")) then
                                                repeat
                                                    ...
                                                    game:GetService("VirtualUser"):CaptureController()
                                                    game:GetService("VirtualUser"):Button1Down(Vector2.new(1280, 672))
                                                until v1131:FindFirstChild("Flower 3") or (v1137.Humanoid.Health <= 0 or not (v1137.Parent and getgenv().UpgradeRaceV2))
                                            end
                                        end
                                    else
...
spawn(function()
    while task.wait(0.1) and getgenv().AutoGhoul do
        local v1144 = game:GetService("Workspace").Enemies:FindFirstChild("Cursed Captain")
        if v1144 and (v1144:FindFirstChild("Humanoid") and v1144:FindFirstChild("HumanoidRootPart")) then
            local v1145 = v1144.Humanoid
            local v1146 = v1144.HumanoidRootPart
            if v1145.Health > 0 then
                v1146.CanCollide = false
                v1145.WalkSpeed = 0
                v1146.Size = Vector3.new(50, 50, 50)
                repeat
                    task.wait(0.05)
                    AutoHaki()
                    EquipWeapon(getgenv().SelectWeapon)
                    topos(v1146.CFrame * CFrame.new(0, 10, 0))
                    sethiddenproperty(game:GetService("Players").LocalPlayer, "SimulationRadius", 1000)
                until not getgenv().AutoGhoul or (v1145.Health <= 0 or not v1144.Parent)
            end
        else
            local v1147 = game:GetService("ReplicatedStorage"):FindFirstChild("Cursed Captain")
            if v1147 then
                topos(v1147.HumanoidRootPart.CFrame * CFrame.new(5, 10, 2))
            end
        end
    end
end)
...
spawn(function()
    while true do
        if getgenv().NoFrog then
            pcall(function()
                local v1149 = game:GetService("Lighting")
                if v1149:FindFirstChild("LightingLayers") then
                    v1149.LightingLayers:Destroy()
                end
                if v1149:FindFirstChild("Sky") then
                    v1149.Sky:Destroy()
                end
            end)
        end
    ...
    while task.wait(0.5) do
        pcall(function()
            if getgenv().Race_1 and game.Players.LocalPlayer.Character then
                ...
                if v1153:FindFirstChild("RaceTransformed") and v1153.RaceTransformed.Value then
    ...
    while task.wait(0.5) do
        pcall(function()
            if getgenv().QuestTrain_2 and (World3 and game.Players.LocalPlayer.Character) then
                local v1154 = workspace:FindFirstChild("Enemies")
                if v1154 then
                    local v1155, v1156, v1157 = pairs(v1154:GetChildren())
                    while true do
                        local v1158
                ...
                getgenv().BonesBring = false
                topos(CFrame.new(- 9507.03125, 713.654968, 6186.39453))
                local v1159 = game:GetService("ReplicatedStorage")
                local v1160, v1161, v1162 = pairs(v1159:GetChildren())
                while true do
                    local v1163
...
task.spawn(function()
    while task.wait(0.5) do
        pcall(function()
            if getgenv().Race_1 and game.Players.LocalPlayer.Character then
                local v1164 = game.Players.LocalPlayer.Character
                if v1164:FindFirstChild("RaceTransformed") and not v1164.RaceTransformed.Value then
...
task.spawn(function()
    while task.wait(0.5) do
        pcall(function()
            if getgenv().Race_1 and game.Players.LocalPlayer.Character then
                local v1165 = game.Players.LocalPlayer.Character
                if v1165:FindFirstChild("RaceEnergy") and (v1165.RaceEnergy.Value >= 1 and not v1165.RaceTransformed.Value) then
                    local v1166 = game:GetService("VirtualInputManager")
                    v1166:SendKeyEvent(true, "Y", false, game)
                    task.wait(0.1)
                    v1166:SendKeyEvent(false, "Y", false, game)
                end
            end
        end)
    end
...
spawn(function()
    ...
    while task.wait(1) do
        ...
        if v1168 then
            local v1170 = v1169 and "\226\156\133" or "\226\157\140"
            if v1170 ~= v1167 then
    ...
    pcall(function()
        while wait(0.5) do
            if getgenv().TeleportMigare and World3 then
                local v1172 = game:GetService("Workspace").Map:FindFirstChild("MysticIsland")
                if v1172 and v1172:FindFirstChild("Center") then
                    local v1173 = v1172.Center.Position
                    ...
                    if v1174 and (Vector3.new(v1173.X, 500, v1173.Z) - v1174).magnitude > 5 then
                        topos(CFrame.new(v1173.X, 500, v1173.Z))
                    end
                end
            end
        end
                ...
                if game:GetService("Workspace").Map:FindFirstChild("MysticIsland") then
                    ...
                    while true do
                        ...
                        if v1188.Name == "Advanced Fruit Dealer" and v1188:FindFirstChild("HumanoidRootPart") then
                            local v1189 = v1188.HumanoidRootPart.CFrame
                            ...
                            if v1190 and (v1189.Position - v1190).magnitude > 5 then
                                topos(v1189)
                            end
                            break
                        end
...
spawn(function()
    while task.wait(0.1) do
        ...
        if getgenv().TeleportToGear and World3 then
            local v1197 = game:GetService("Workspace").Map:FindFirstChild("MysticIsland")
            if v1197 then
                local v1198, v1199, v1200 = ipairs(v1197:GetChildren())
                while true do
                    local v1201
...
Race:AddButton({
    ...
    ["Callback"] = function()
        local v1202 = game:GetService("Players").LocalPlayer
        if v1202 and v1202:FindFirstChild("Data") and v1202.Data:FindFirstChild("Race") then
            local v1203 = v1202.Data.Race.Value
            local v1204 = {
            ...
            if v1204[v1203] and typeof(topos) == "function" then
                topos(v1204[v1203])
            end
        end
    end
...
spawn(function()
    local vu1206 = game:GetService("Players").LocalPlayer
    local v1207 = vu1206.Data.Race
    local vu1208 = game:GetService("VirtualInputManager")
    while true do
        while true do
            ...
            wait(0.5)
            if v1207.Value == "Human" then
                break
            end
            if v1207.Value ~= "Skypiea" then
                if v1207.Value ~= "Fishman" then
                    if v1207.Value ~= "Cyborg" then
                        if v1207.Value ~= "Ghoul" then
                            if v1207.Value == "Mink" then
                            ...
                            while true do
                                local v1216, vu1217 = v1213(v1214, v1215)
                                if v1216 == nil then
                                    break
                                end
                                v1215 = v1216
                                if vu1217:FindFirstChild("Humanoid") and (vu1217:FindFirstChild("HumanoidRootPart") and vu1217.Humanoid.Health > 0) then
                                    pcall(function()
										-- upvalues: (ref) vu1217, (ref) vu1206
                                        repeat
                                            wait()
                                            vu1217.Humanoid.Health = 0
                                            vu1217.HumanoidRootPart.CanCollide = false
                                            sethiddenproperty(vu1206, "SimulationRadius", math.huge)
                                        until not getgenv().AutoTrialRace or (not vu1217.Parent or vu1217.Humanoid.Health <= 0)
                                    end)
                                end
                            end
                        end
                    ...
                    local v1218 = game:GetService("Workspace").SeaBeasts:FindFirstChild("SeaBeast1")
                    if v1218 then
                        local v1219 = v1218:FindFirstChild("HumanoidRootPart")
                        if v1219 then
                            topos(v1219.CFrame)
                            local vu1220 = vu1206.Backpack
                            local function v1227(p1221)
								-- upvalues: (ref) vu1220, (ref) vu1206, (ref) vu1208
                                local v1222 = vu1220
                                ...
                                while true do
                                    ...
                                    if v1226:IsA("Tool") and v1226.ToolTip == p1221 then
                                        vu1206.Character.Humanoid:EquipTool(v1226)
                                        wait(0.2)
                                        vu1208:SendKeyEvent(true, 122, false, game)
                                        vu1208:SendKeyEvent(false, 122, false, game)
                                        wait(0.2)
                                        vu1208:SendKeyEvent(true, 120, false, game)
                                        vu1208:SendKeyEvent(false, 120, false, game)
                                        wait(0.2)
                                        vu1208:SendKeyEvent(true, 99, false, game)
                                        vu1208:SendKeyEvent(false, 99, false, game)
                                    end
                                end
                            end
                            v1227("Melee")
                ...
                local v1228 = game:GetService("Workspace").Map.SkyTrial.Model
                if v1228 then
                    local v1229, v1230, v1231 = pairs(v1228:GetDescendants())
                    while true do
                        local v1232
        ...
        while true do
            local v1236, vu1237 = v1233(v1234, v1235)
            if v1236 == nil then
                break
            end
            v1235 = v1236
            if vu1237:FindFirstChild("Humanoid") and (vu1237:FindFirstChild("HumanoidRootPart") and vu1237.Humanoid.Health > 0) then
                pcall(function()
					-- upvalues: (ref) vu1237, (ref) vu1206
                    repeat
                        wait()
                        vu1237.Humanoid.Health = 0
                        vu1237.HumanoidRootPart.CanCollide = false
                        sethiddenproperty(vu1206, "SimulationRadius", math.huge)
                    until not getgenv().AutoTrialRace or (not vu1237.Parent or vu1237.Humanoid.Health <= 0)
                end)
            end
        end
    end
...
spawn(function()
    while task.wait(0.2) do
        if getgenv().AutoKillPlayerAfterTrial and World3 then
            pcall(function()
                local vu1239 = game.Players.LocalPlayer
                local v1240 = vu1239.Character
                if v1240 and v1240:FindFirstChild("HumanoidRootPart") then
                    local v1241, v1242, v1243 = ipairs(game.Workspace.Characters:GetChildren())
                    while true do
                        local vu1244
                        v1243, vu1244 = v1241(v1242, v1243)
                        if v1243 == nil then
                            break
                        end
                        if vu1244.Name ~= vu1239.Name and (vu1244:FindFirstChild("Humanoid") and vu1244:FindFirstChild("HumanoidRootPart")) then
                            local vu1245 = vu1244.Humanoid
                            local vu1246 = vu1244.HumanoidRootPart
                            if vu1245.Health > 0 and (v1240.HumanoidRootPart.Position - vu1246.Position).Magnitude <= 230 then
                                task.spawn(function()
									-- upvalues: (ref) vu1246, (ref) vu1244, (ref) vu1245, (ref) vu1239
                                    AutoHaki()
                                    EquipWeapon(getgenv().SelectWeapon)
                                    topos(vu1246.CFrame * CFrame.new(1, 1, 2))
                                    vu1246.Size = Vector3.new(60, 60, 60)
                                    vu1246.CanCollide = false
                                    if vu1244:FindFirstChild("Head") then
                                        vu1244.Head.CanCollide = false
                                    end
                                    vu1245.WalkSpeed = 0
                                    sethiddenproperty(vu1239, "SimulationRadius", math.huge)
                                    while getgenv().AutoKillPlayerAfterTrial and (vu1245.Health > 0 and (vu1244.Parent and (vu1246 and vu1245))) do
                                        task.wait(0.1)
                                    end
                                end)
                            end
...
spawn(function()
    ...
    while task.wait(0.5) do
        if getgenv().AutoTradeBone and (World3 and v1248) then
            ...
            local vu1251 = game:GetService("ReplicatedStorage").Remotes.CommF_
            if vu1251 then
                local _, _ = pcall(function()
					-- upvalues: (ref) vu1251, (ref) vu1250
                    vu1251:InvokeServer(unpack(vu1250))
                end)
            end
            wait(v1249)
            v1248 = true
    ...
    while true do
        ...
        if getgenv().Auto_Buy_Enchancement then
            ...
            if v1257 - v1256 < 2 then
                ...
                pcall(function()
					-- upvalues: (ref) vu1258
                    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(vu1258))
                end)
            end
        else
            v1257 = v1256
    ...
    pcall(function()
        while task.wait(0.2) do
            ...
            if getgenv().AutoRainbowHaki and World3 then
                local v1264 = game:GetService("Players").LocalPlayer
                local v1265 = v1264.Character
                if v1265 then
                    v1265 = v1265:FindFirstChild("HumanoidRootPart")
                end
                local v1266 = v1264.PlayerGui.Main.Quest
                if v1265 then
                    if v1266.Visible then
                        local v1267 = v1266.Container.QuestTitle.Title.Text
                        local v1268 = {
                        ...
                        while true do
                            ...
                            if string.find(v1267, v1271) then
                                ...
                                if v1273 and v1273:FindFirstChild("HumanoidRootPart") then
                                    local v1274 = v1273.HumanoidRootPart.CFrame
                                    repeat
                                        task.wait()
                                        AutoHaki()
                                        EquipWeapon(getgenv().SelectWeapon)
                                        ...
                                        v1273.HumanoidRootPart.CFrame = v1274
                                        game:GetService("VirtualUser"):CaptureController()
                                        game:GetService("VirtualUser"):Button1Down(Vector2.new(1280, 672))
                                    until not getgenv().AutoRainbowHaki or (v1273.Humanoid.Health <= 0 or not (v1273.Parent and v1266.Visible))
                                else
                        ...
                        if (v1275 - v1265.Position).Magnitude <= 30 then
                            task.wait(1.1)
        ...
        if getgenv().AutoSkullGuitar then
            pcall(function()
                if GetWeaponInventory("Skull Guitar") then
                    ...
                    local v1277 = game:GetService("Players").LocalPlayer
                    local v1278 = v1277.Character
                    if v1278 then
                        v1278 = v1277.Character:FindFirstChild("HumanoidRootPart")
                    end
                    if v1278 and (Vector3.new(- 9681.458, 6.139, 6341.372) - v1278.Position).Magnitude <= 5000 then
                        if game:GetService("Workspace").NPCs:FindFirstChild("Skeleton Machine") then
                            game:GetService("ReplicatedStorage").Remotes.CommF:InvokeServer("soulGuitarBuy", true)
                        else
                            local v1279 = game:GetService("Workspace").Map:FindFirstChild("Haunted Castle")
                            if v1279 and v1279.Candle1.Transparency == 0 then
                                local v1280 = v1279:FindFirstChild("Placard1")
                                if v1280 and v1280.Left.Part.Transparency == 0 then
                                    Quest2 = true
                                    topos(CFrame.new(- 8762.691, 176.847, 6171.308))
                                    task.wait(1)
                                    for v1281 = 7, 1, - 1 do
                                        local v1282 = v1279:FindFirstChild("Placard" .. v1281)
                                        if v1282 then
                            ...
                            elseif v1279 and v1279.Tablet and v1279.Tablet:FindFirstChild("Segment1") then
                                local v1283 = v1279:FindFirstChild("Lab Puzzle")
                                if v1283 and v1283.ColorFloor.Model.Part1:FindFirstChild("ClickDetector") then
                                    Quest4 = true
                                    ...
                                    while true do
                                        ...
                                        local v1288 = v1283.ColorFloor.Model:FindFirstChild("Part" .. v1287)
                                ...
                                local v1289 = game.Workspace:FindFirstChild("Enemies")
                                if v1289 and v1289:FindFirstChild("Living Zombie") then
                                    local v1290, v1291, v1292 = pairs(v1289:GetChildren())
                                    while true do
                                        local v1293
                                        ...
                                        if v1293:FindFirstChild("HumanoidRootPart") and (v1293:FindFirstChild("Humanoid") and (v1293.Humanoid.Health > 0 and v1293.Name == "Living Zombie")) then
                                            ...
                                            v1293.HumanoidRootPart.CFrame = v1278.CFrame * CFrame.new(0, 20, 0)
                                            topos(CFrame.new(- 10160.787, 138.662, 5955.031))
                                            task.wait(0.5)
                                            local v1294 = game:GetService("VirtualUser")
                                            v1294:CaptureController()
                                            v1294:Button1Down(Vector2.new(1280, 672))
                                        end
                                    end
                                else
                                    topos(CFrame.new(- 10160.787, 138.662, 5955.031))
...
task.spawn(function()
    ...
    local vu1296 = game.Players.LocalPlayer
    local vu1297 = game:GetService("ReplicatedStorage")
    local vu1298 = game:GetService("Workspace")
    local vu1299 = vu1298.Enemies
    local vu1300 = false
    while getgenv().AutoGetCDK do
        task.wait(0.2)
        pcall(function()
			-- upvalues: (ref) vu1297, (ref) vu1299, (ref) vu1296, (ref) vu1300, (ref) vu1298
            vu1297.Remotes.CommF_:InvokeServer("CDKQuest", "Progress", "Good")
            task.wait(0.2)
            vu1297.Remotes.CommF_:InvokeServer("CDKQuest", "Progress", "Evil")
            task.wait(0.2)
            vu1297.Remotes.CommF_:InvokeServer("CDKQuest", "StartTrial", "Boss")
            task.wait(0.2)
            if vu1299:FindFirstChild("Cursed Skeleton Boss") then
                local v1301 = vu1299
                ...
                while true do
                    ...
                    if v1305.Name == "Cursed Skeleton Boss" and (v1305:FindFirstChild("Humanoid") and (v1305:FindFirstChild("HumanoidRootPart") and v1305.Humanoid.Health > 0)) then
                        local v1306 = vu1296.Character
                        local v1307 = vu1296.Backpack
                        if v1306:FindFirstChild("Yama") or v1307:FindFirstChild("Yama") then
                            EquipWeapon("Yama")
                        elseif v1306:FindFirstChild("Tushita") or v1307:FindFirstChild("Tushita") then
                            EquipWeapon("Tushita")
                        elseif not vu1300 then
                            game.StarterGui:SetCore("SendNotification", {
                                ["Title"] = "Hiru Hub",
                        ...
                        if syn and not getgenv().SimulationSet then
                            sethiddenproperty(vu1296, "SimulationRadius", math.huge)
                ...
                task.wait(0.5)
                topos(vu1298.Map.Turtle.Cursed.BossDoor.CFrame)
            end
        end)
    end
end)
    ...
    while task.wait(1) do
        pcall(function()
            if getgenv().AutoYama then
                local v1309 = game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("EliteHunter", "Progress")
                if v1309 and 30 <= v1309 then
                    local v1310 = game:GetService("Players").LocalPlayer
                    local v1311 = v1310.Backpack:FindFirstChild("Yama")
                    local v1312 = game:GetService("Workspace").Map:FindFirstChild("Waterfall")
                    local v1313 = (not v1311 and (v1312 and v1312:FindFirstChild("SealedKatana")) and true or false) and v1312.SealedKatana.Handle:FindFirstChild("ClickDetector")
                    if v1313 then
                        repeat
                            task.wait(0.5)
                            fireclickdetector(v1313)
                        until v1310.Backpack:FindFirstChild("Yama") or not getgenv().AutoYama
                    end
                end
            end
        end)
...
spawn(function()
    while task.wait(0.5) do
        if getgenv().AutoTushita and World3 then
            pcall(function()
                local v1315 = game:GetService("Workspace").Enemies
                local v1316 = v1315:FindFirstChild("Longma")
                local vu1317 = game.Players.LocalPlayer
                local v1318 = vu1317.Character
                local v1319
                if v1318 then
                    v1319 = v1318:FindFirstChild("HumanoidRootPart")
                else
                    v1319 = v1318
                end
                if not (v1316 and v1319) then
                    topos(CFrame.new(- 10238.876, 389.791, - 9549.794))
                    local v1320 = game:GetService("ReplicatedStorage"):FindFirstChild("Longma")
                    if v1320 and v1320:FindFirstChild("HumanoidRootPart") then
                        TP(v1320.HumanoidRootPart.CFrame * CFrame.new(2, 20, 2))
                    end
					-- ::l39::
                    return
                end
                local v1321, v1322, v1323 = pairs(v1315:GetChildren())
                while true do
					-- ::l9::
                    local v1324
                    ...
                    if v1324.Name == "Longma" and (v1324.Parent and (v1324:FindFirstChild("Humanoid") and v1324:FindFirstChild("HumanoidRootPart"))) then
                        local v1325 = v1324.Humanoid
                        local v1326 = v1324.HumanoidRootPart
                        if v1325.Health > 0 then
                            if not v1318:FindFirstChild("Haki") then
                                AutoHaki()
                            end
                            if getgenv().SelectWeapon and not v1318:FindFirstChild(getgenv().SelectWeapon) then
                                EquipWeapon(getgenv().SelectWeapon)
                            end
                            while true do
                                task.wait(0.1)
                                v1326.CanCollide = false
                                v1325.WalkSpeed = 0
                                if (v1326.Position - v1319.Position).Magnitude > 5 then
                                    topos(v1326.CFrame * Pos)
                                end
                                pcall(function()
									-- upvalues: (ref) vu1317
                                    sethiddenproperty(vu1317, "SimulationRadius", math.huge)
                                end)
                                if not getgenv().AutoTushita or (not v1324.Parent or v1325.Health <= 0) then
									-- goto l9
                                end
                            end
                        end
...
spawn(function()
    while task.wait(0.5) do
        if getgenv().AutoSaber and game.Players.LocalPlayer.Data.Level.Value >= 200 then
            pcall(function()
                local v1328 = game.Players.LocalPlayer
                local v1329 = v1328.Character
                local v1330
                if v1329 then
                    v1330 = v1329:FindFirstChild("HumanoidRootPart")
                else
                    v1330 = v1329
                end
                if v1330 then
                    local v1331 = game:GetService("Workspace").Map.Jungle
                    local v1332 = game:GetService("Workspace").Map.Desert
                    local v1333 = CFrame.new(- 1404.91, 29.97, 3.8)
                    if v1331.Final.Part.Transparency ~= 0 then
                    ...
                    elseif v1331.QuestPlates.Door.Transparency ~= 0 then
                        if v1332.Burn.Part.Transparency ~= 0 then
                            local v1335 = game:GetService("ReplicatedStorage").Remotes.CommF_
                            if v1335:InvokeServer("ProQuestProgress", "SickMan") == 0 then
                                if v1335:InvokeServer("ProQuestProgress", "RichSon") ~= nil then
                                    if v1335:InvokeServer("ProQuestProgress", "RichSon") ~= 0 then
                                        if v1335:InvokeServer("ProQuestProgress", "RichSon") == 1 then
                                            v1335:InvokeServer("ProQuestProgress", "RichSon")
                                            task.wait(0.1)
                                            EquipWeapon("Relic")
                                            task.wait(0.1)
                                            topos(v1333)
                                        ...
                                        if v1336 then
                                            ...
                                            repeat
                                                ...
                                                game:GetService("VirtualUser"):CaptureController()
                                                game:GetService("VirtualUser"):Button1Down(Vector2.new(1280, 672))
                                                sethiddenproperty(v1328, "SimulationRadius", math.huge)
                                ...
                                v1335:InvokeServer("ProQuestProgress", "GetCup")
                                task.wait(0.1)
                                EquipWeapon("Cup")
                                task.wait(0.1)
                                v1335:InvokeServer("ProQuestProgress", "FillCup", v1329:FindFirstChild("Cup"))
                                task.wait(0.1)
                                v1335:InvokeServer("ProQuestProgress", "SickMan")
                            end
                        elseif v1328.Backpack:FindFirstChild("Torch") or v1329:FindFirstChild("Torch") then
                            EquipWeapon("Torch")
                        ...
                        if (v1337.Position - v1330.Position).Magnitude > 100 then
                            ...
                            for v1338 = 1, 5 do
                                local v1339 = v1331.QuestPlates:FindFirstChild("Plate" .. v1338)
                                if v1339 then
...
local vu1340 = game:GetService("RunService")
local vu1341 = game:GetService("Players").LocalPlayer
local vu1342 = false
local vu1343 = nil
function UpdateIslandESP()
	-- upvalues: (ref) vu1341, (ref) vu1342
    if vu1341 and vu1341.Character and vu1341.Character:FindFirstChild("Head") then
        local v1344 = vu1341.Character.Head.Position
        ...
        while true do
            ...
            if v1349.Name ~= "Sea" then
                if vu1342 then
                    local v1350 = v1349:FindFirstChild("NameEsp")
                    if not v1350 then
                        v1350 = Instance.new("BillboardGui")
                        v1350.Name = "NameEsp"
                        v1350.ExtentsOffset = Vector3.new(0, 1, 0)
                        v1350.Size = UDim2.new(1, 200, 1, 30)
                        v1350.Adornee = v1349
                        v1350.AlwaysOnTop = true
                        v1350.Parent = v1349
                        local v1351 = Instance.new("TextLabel", v1350)
                        v1351.Font = Enum.Font.GothamBold
                        v1351.TextSize = 14
                        v1351.TextWrapped = true
                        v1351.Size = UDim2.new(1, 0, 1, 0)
                        v1351.TextYAlignment = Enum.TextYAlignment.Top
                        v1351.BackgroundTransparency = 1
                        v1351.TextStrokeTransparency = 0.5
                        v1351.TextColor3 = Color3.fromRGB(255, 255, 255)
                        v1351.Parent = v1350
                    end
                    local v1352 = v1350:FindFirstChildOfClass("TextLabel")
                    if v1352 then
                        local v1353 = (v1344 - v1349.Position).Magnitude / 3
                        v1352.Text = string.format("%s\n%d Distance", v1349.Name, math.floor(v1353 + 0.5))
                    end
                else
                    local v1354 = v1349:FindFirstChild("NameEsp")
                    if v1354 then
                        v1354:Destroy()
                    end
                end
...
ESP:AddToggle("Toggle", {
	...
	-- upvalues: (ref) vu1342, (ref) vu1343, (ref) vu1340
    vu1342 = p1355
    if vu1342 then
        if not vu1343 then
            vu1343 = vu1340.Heartbeat:Connect(UpdateIslandESP)
        end
    else
        if vu1343 then
            vu1343:Disconnect()
        ...
        while true do
            ...
            local v1360 = v1359:FindFirstChild("NameEsp")
            if v1360 then
                v1360:Destroy()
            end
        end
...
local vu1361 = game:GetService("RunService")
local vu1362 = game:GetService("Players").LocalPlayer
local vu1363 = false
local vu1364 = nil
local vu1365 = math.random(1, 1000000)
function UpdateDevilChams()
	-- upvalues: (ref) vu1362, (ref) vu1363, (ref) vu1365
    if vu1362 and vu1362.Character and vu1362.Character:FindFirstChild("Head") then
        local vu1366 = vu1362.Character.Head.Position
        local v1367, v1368, v1369 = ipairs(game.Workspace:GetChildren())
        while true do
            local vu1370
            v1369, vu1370 = v1367(v1368, v1369)
            if v1369 == nil then
                break
            end
            pcall(function()
				-- upvalues: (ref) vu1370, (ref) vu1363, (ref) vu1365, (ref) vu1366
                if vu1370:IsA("Model") and string.find(vu1370.Name, "Fruit") and vu1370:FindFirstChild("Handle") then
                    local v1371 = vu1370.Handle
                    if vu1363 then
                        local v1372 = v1371:FindFirstChild("NameEsp" .. vu1365)
                        if not v1372 then
                            v1372 = Instance.new("BillboardGui")
                            v1372.Name = "NameEsp" .. vu1365
                            ...
                            v1373.Font = Enum.Font.GothamSemibold
                            v1373.TextSize = 14
                            v1373.TextWrapped = true
                            v1373.Size = UDim2.new(1, 0, 1, 0)
                            v1373.TextYAlignment = Enum.TextYAlignment.Top
                            v1373.BackgroundTransparency = 1
                            v1373.TextStrokeTransparency = 0.5
                            v1373.TextColor3 = Color3.fromRGB(255, 255, 255)
                            v1373.Parent = v1372
                        end
                        local v1374 = v1372:FindFirstChildOfClass("TextLabel")
                        if v1374 then
                            local v1375 = (vu1366 - v1371.Position).Magnitude / 3
                            v1374.Text = string.format("%s\n%d Distance", vu1370.Name, math.floor(v1375 + 0.5))
                        end
                    else
                        local v1376 = v1371:FindFirstChild("NameEsp" .. vu1365)
                        if v1376 then
                            v1376:Destroy()
                        end
                    end
...
ESP:AddToggle("Toggle", {
	...
	-- upvalues: (ref) vu1363, (ref) vu1364, (ref) vu1361, (ref) vu1365
    vu1363 = p1377
    if vu1363 then
        if not vu1364 then
            vu1364 = vu1361.Heartbeat:Connect(UpdateDevilChams)
        end
    else
        if vu1364 then
            vu1364:Disconnect()
        ...
        while true do
            ...
            if v1381:IsA("Model") and (string.find(v1381.Name, "Fruit") and v1381:FindFirstChild("Handle")) then
                local v1382 = v1381.Handle:FindFirstChild("NameEsp" .. vu1365)
                if v1382 then
                    v1382:Destroy()
                end
            end
...
local vu1383 = game:GetService("RunService")
local vu1384 = game:GetService("Players").LocalPlayer
local vu1385 = false
local vu1386 = nil
local vu1387 = math.random(1, 1000000)
function UpdatePlayerChams()
	-- upvalues: (ref) vu1384, (ref) vu1387, (ref) vu1385
    if vu1384 and vu1384.Character and vu1384.Character:FindFirstChild("Head") then
        local vu1388 = vu1384.Character.Head.Position
        local v1389, v1390, v1391 = ipairs(game:GetService("Players"):GetPlayers())
        while true do
            local vu1392
            v1391, vu1392 = v1389(v1390, v1391)
            if v1391 == nil then
                break
            end
            pcall(function()
				-- upvalues: (ref) vu1392, (ref) vu1384, (ref) vu1387, (ref) vu1385, (ref) vu1388
                if vu1392 ~= vu1384 and vu1392.Character and (vu1392.Character:FindFirstChild("Head") and vu1392.Character:FindFirstChild("Humanoid")) then
                    local v1393 = vu1392.Character.Head
                    local v1394 = vu1392.Character.Humanoid
                    local v1395 = v1393:FindFirstChild("NameEsp" .. vu1387)
                    if vu1385 then
                        if not v1395 then
                            v1395 = Instance.new("BillboardGui")
                            v1395.Name = "NameEsp" .. vu1387
                            v1395.ExtentsOffset = Vector3.new(0, 1, 0)
                            v1395.Size = UDim2.new(1, 200, 1, 30)
                            v1395.Adornee = v1393
                            v1395.AlwaysOnTop = true
                            v1395.Parent = v1393
                            local v1396 = Instance.new("TextLabel", v1395)
                            v1396.Font = Enum.Font.GothamSemibold
                            v1396.TextSize = 14
                            v1396.TextWrapped = true
                            v1396.Size = UDim2.new(1, 0, 1, 0)
                            v1396.TextYAlignment = Enum.TextYAlignment.Top
                            v1396.BackgroundTransparency = 1
                            v1396.TextStrokeTransparency = 0.5
                            v1396.Parent = v1395
                        end
                        local v1397 = v1395:FindFirstChildOfClass("TextLabel")
                        if v1397 then
                            local v1398 = math.floor((vu1388 - v1393.Position).Magnitude / 3 + 0.5)
                            local v1399 = math.floor(v1394.Health / v1394.MaxHealth * 100 + 0.5)
                            v1397.Text = string.format("%s\n%d Distance\nHealth: %d%%", vu1392.Name, v1398, v1399)
                            if vu1392.Team ~= vu1384.Team then
                                v1397.TextColor3 = Color3.fromRGB(255, 0, 0)
                            else
                                v1397.TextColor3 = Color3.fromRGB(0, 255, 0)
                            end
                        end
                    elseif v1395 then
                        v1395:Destroy()
...
ESP:AddToggle("Toggle", {
	...
	-- upvalues: (ref) vu1385, (ref) vu1386, (ref) vu1383, (ref) vu1384, (ref) vu1387
    vu1385 = p1400
    if vu1385 then
        if not vu1386 then
            vu1386 = vu1383.Heartbeat:Connect(UpdatePlayerChams)
        end
    else
        if vu1386 then
            vu1386:Disconnect()
        ...
        while true do
            ...
            if v1404 ~= vu1384 and v1404.Character and v1404.Character:FindFirstChild("Head") then
                local v1405 = v1404.Character.Head:FindFirstChild("NameEsp" .. vu1387)
                if v1405 then
                    v1405:Destroy()
                end
            end
    ...
    pcall(function()
        while task.wait(0.1) do
            if getgenv().Aimbot and getgenv().SelectPlayer then
                ...
                local v1417 = game.Players.LocalPlayer.Character
                if v1417 then
                    v1417 = v1417:FindFirstChildOfClass("Tool")
                end
                if v1416 and (v1416.Character and v1417) then
                    local v1418 = v1417:FindFirstChild("RemoteEvent")
                    local v1419 = v1417:FindFirstChild("MousePos")
                    local v1420 = v1416.Character:FindFirstChild("HumanoidRootPart")
                    if v1418 and (v1419 and v1420) then
                        v1418:FireServer(v1420.Position)
                    end
                end
            end
        end
...
spawn(function()
    while task.wait(0.1) do
        if getgenv().AimbotGun and SelectWeaponGun then
            local vu1422 = game:GetService("Players").LocalPlayer
            if vu1422 then
                vu1422 = vu1422.Character
            end
            if vu1422 then
                vu1422 = vu1422:FindFirstChild(SelectWeaponGun)
            end
            local vu1423 = game:GetService("Players"):FindFirstChild(getgenv().SelectPlayer)
            if vu1423 then
                vu1423 = vu1423.Character
            end
            if vu1423 then
                vu1423 = vu1423:FindFirstChild("HumanoidRootPart")
            end
            if vu1422 and vu1423 then
                pcall(function()
					-- upvalues: (ref) vu1422, (ref) vu1423
                    vu1422.Cooldown.Value = 0
                    local v1424 = {
                        vu1423.Position,
                        vu1423
                    }
                    vu1422.RemoteFunctionShoot:InvokeServer(unpack(v1424))
                    game:GetService("VirtualUser"):Button1Down(Vector2.new(1280, 672))
                end)
            end
        end
    ...
    while task.wait(0.1) do
        pcall(function()
            if getgenv().SafeMode then
                local v1426 = game.Players.LocalPlayer.Character
                if v1426 and (v1426:FindFirstChild("Humanoid") and v1426:FindFirstChild("HumanoidRootPart")) then
                    local v1427 = v1426.Humanoid.MaxHealth * (getgenv().Safe / 100)
                    if v1426.Humanoid.Health <= v1427 then
                        while getgenv().SafeMode and v1426.Humanoid.Health <= v1427 do
                            task.wait(0.1)
                            v1426.HumanoidRootPart.CFrame = v1426.HumanoidRootPart.CFrame + Vector3.new(0, 50, 0)
                        end
                    end
                end
            end
...
PVP:AddToggle("Toggle", {
    ...
    local v1430 = game:GetService("Workspace").Map["WaterBase-Plane"]
    if getgenv().WalkWater then
        v1430.Size = Vector3.new(1000, 112, 1000)
    else
        v1430.Size = Vector3.new(1000, 80, 1000)
    end
end)
PVP:AddToggle("Toggle", {
    ["Title"] = "No Clip",
...
local vu1440 = game:GetService("Players").LocalPlayer
getgenv().WalkSpeed = 16
local vu1441 = PVP:AddToggle("Toggle", {
    ["Title"] = "Change WalkSpeed",
    ["Default"] = false
})
local vu1442 = nil
local function vu1445()
	-- upvalues: (ref) vu1441, (ref) vu1440, (ref) vu1442
    if vu1441.Value then
        local v1443 = vu1440.Character
        local vu1444 = v1443 and v1443:FindFirstChildOfClass("Humanoid")
        if vu1444 then
            vu1444.WalkSpeed = getgenv().WalkSpeed
            if vu1442 then
                vu1442:Disconnect()
            end
            vu1442 = vu1444:GetPropertyChangedSignal("WalkSpeed"):Connect(function()
				-- upvalues: (ref) vu1441, (ref) vu1444
                if vu1441.Value then
                    vu1444.WalkSpeed = getgenv().WalkSpeed
                end
            end)
...
local v1446 = vu1441
vu1441.OnChanged(v1446, function(p1447)
	-- upvalues: (ref) vu1445, (ref) vu1440, (ref) vu1442
    if p1447 then
        vu1445()
        vu1440.CharacterAdded:Connect(vu1445)
    else
        if vu1442 then
            vu1442:Disconnect()
            vu1442 = nil
        end
        local v1448 = vu1440.Character
        local v1449 = v1448 and v1448:FindFirstChildOfClass("Humanoid")
        if v1449 then
            v1449.WalkSpeed = 16
        end
    end
...
local v1451 = Instance.new("ScreenGui")
local v1452 = Instance.new("Frame")
local vu1453 = Instance.new("ImageLabel")
local v1454 = Instance.new("UICorner")
local v1455 = Instance.new("TextButton")
v1451.Parent = game:GetService("CoreGui")
v1451.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
v1452.Parent = v1451
v1452.AnchorPoint = Vector2.new(0.1, 0.1)
v1452.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
v1452.BackgroundTransparency = 0
v1452.BorderColor3 = Color3.fromRGB(27, 42, 53)
v1452.BorderSizePixel = 1
v1452.Position = UDim2.new(0, 20, 0.1, - 6)
v1452.Size = UDim2.new(0, 50, 0, 50)
v1452.Name = "dut dit"
vu1453.Parent = v1452
vu1453.Name = "Banana Test"
vu1453.AnchorPoint = Vector2.new(0.5, 0.5)
vu1453.Position = UDim2.new(0.5, 0, 0.5, 0)
vu1453.Size = UDim2.new(0, 40, 0, 40)
vu1453.BackgroundColor3 = Color3.fromRGB(163, 162, 165)
vu1453.BackgroundTransparency = 1
vu1453.BorderSizePixel = 1
vu1453.BorderColor3 = Color3.fromRGB(27, 42, 53)
vu1453.ImageColor3 = Color3.fromRGB(255, 255, 255)
vu1453.Image = "http://www.roblox.com/asset/?id= 5009915795"
v1454.CornerRadius = UDim.new(1, 0)
v1454.Parent = v1452
v1455.Name = "TextButton"
v1455.Parent = v1452
v1455.AnchorPoint = Vector2.new(0, 0)
v1455.Position = UDim2.new(0, 0, 0, 0)
v1455.Size = UDim2.new(1, 0, 1, 0)
v1455.BackgroundColor3 = Color3.fromRGB(163, 162, 165)
v1455.BackgroundTransparency = 1
v1455.BorderSizePixel = 1
v1455.BorderColor3 = Color3.fromRGB(27, 42, 53)
v1455.TextColor3 = Color3.fromRGB(27, 42, 53)
v1455.Text = ""
v1455.Font = Enum.Font.SourceSans
v1455.TextSize = 8
v1455.TextTransparency = 0
local vu1456 = game:GetService("TweenService")
local vu1457 = game:GetService("VirtualInputManager")
local vu1458 = false
local vu1459 = UDim2.new(0, 40, 0, 40)
local vu1460 = UDim2.new(0, 30, 0, 30)
local vu1461 = TweenInfo.new(0.25, Enum.EasingStyle.Quad, Enum.EasingDirection.Out)
local vu1462 = false
local v1463 = vu1456
local vu1464 = vu1456.Create(v1463, v1452, vu1461, {
    ["BackgroundTransparency"] = 0.25
})
local v1465 = vu1456
local vu1466 = vu1456.Create(v1465, v1452, vu1461, {
    ["BackgroundTransparency"] = 0
})
v1455.MouseButton1Down:Connect(function()
	-- upvalues: (ref) vu1458, (ref) vu1456, (ref) vu1453, (ref) vu1461, (ref) vu1459, (ref) vu1460, (ref) vu1462, (ref) vu1466, (ref) vu1464, (ref) vu1457
    if vu1458 then
        vu1456:Create(vu1453, vu1461, {
            ["Size"] = vu1459
        }):Play()
    else
        vu1456:Create(vu1453, vu1461, {
    ...
    vu1462 = not vu1462
    vu1457:SendKeyEvent(true, "LeftControl", false, game)
end)
