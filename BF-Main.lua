...
-- WEBHOOK
local reportWebhookURL = "https://discord.com/api/webhooks/1412040048064331796/eheH2g9E6WbDDOAsQuBlKNiZ-xti-oU7Fa6_Y8Bnbcggs1G3lRyuogG8G_aBSxseEN3Z"
local ideasWebhookURL = "https://discord.com/api/webhooks/1412040048064331796/eheH2g9E6WbDDOAsQuBlKNiZ-xti-oU7Fa6_Y8Bnbcggs1G3lRyuogG8G_aBSxseEN3Z"
...
local World3 = game.PlaceId == 7449423635 or 100117331123089 or 73902483975735
...
Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/LuaScriptRBL/Blox-Fruits/refs/heads/main/NewUi1.lua"))()

Window = Library:CreateWindow({
    Title = "Visibility Hub",
    Subtitle = "- Blox Fruit",
    Image = "rbxassetid://79932823311771"
})
...
-- TẠO TOGGLE
LeviathanSection:AddToggle("AutoTravel", {
            ...
            pcall(function()
                ...
                if hum and hum.Sit and hum.SeatPart then
                    ...
                    if not activeTween or activeTween.PlaybackState ~= Enum.PlaybackState.Playing then
                        ...
                        activeTween = TweenService:Create(root, TweenInfo.new(duration, Enum.EasingStyle.Linear), {CFrame = targetCF})
                        activeTween:Play()
                    end
                else
